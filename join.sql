...
--   총 검증된 조인 성공 관계: 49개
--   생성일시: 2026-05-31T11:35:12.122Z
-- =============================================================================

-- -----------------------------------------------------------------------------
-- 1. [HIGH] C001.LCNS_NO ↔ I1260.LCNS_NO
...
-- -----------------------------------------------------------------------------
-- 2. [HIGH] I2859.LCNS_NO ↔ I1220.LCNS_NO
...
-- -----------------------------------------------------------------------------
-- 3. [HIGH] I2712.LCNS_NO ↔ I2713.LCNS_NO
...
-- -----------------------------------------------------------------------------
-- 4. [HIGH] I0960.TESTITM_CD ↔ I2530.TESTITM_CD
...
-- -----------------------------------------------------------------------------
-- 5. [HIGH] I0610.LCNS_NO ↔ I1300.LCNS_NO
...
-- -----------------------------------------------------------------------------
-- 6. [HIGH] I2851.LCNS_NO ↔ I2713.LCNS_NO
...
-- -----------------------------------------------------------------------------
-- 7. [HIGH] I1670.DSPS_STDR_CD ↔ I2550.DSPS_STDR_CD
...
-- -----------------------------------------------------------------------------
-- 8. [HIGH] I2851.PRDLST_REPORT_NO ↔ I2711.PRDLST_REPORT_NO
...
-- -----------------------------------------------------------------------------
-- 9. [HIGH] I2712.PRDLST_REPORT_NO ↔ I2711.PRDLST_REPORT_NO
...
-- -----------------------------------------------------------------------------
-- 11. [SUGGESTED] I0580.LCNS_NO ↔ I1220.LCNS_NO
...
-- -----------------------------------------------------------------------------
-- 12. [HIGH] I2711.LCNS_NO ↔ I2713.LCNS_NO
...
-- -----------------------------------------------------------------------------
-- 13. [HIGH] I2600.CMMN_SPEC_CD ↔ I2590.CMMN_SPEC_CD
...
-- -----------------------------------------------------------------------------
-- 14. [HIGH] I0080.LCNS_NO ↔ I1300.LCNS_NO
...
-- -----------------------------------------------------------------------------
-- 16. [SUGGESTED] C002.LCNS_NO ↔ I1220.LCNS_NO
...
-- -----------------------------------------------------------------------------
-- 19. [SUGGESTED] I1230.LCNS_NO ↔ I2500.LCNS_NO
...
-- -----------------------------------------------------------------------------
-- 20. [SUGGESTED] C006.LCNS_NO ↔ I1300.LCNS_NO
...
-- -----------------------------------------------------------------------------
-- 21. [SUGGESTED] I0490.PRDLST_CD ↔ I2510.PRDLST_CD
...
-- -----------------------------------------------------------------------------
-- 22. [HIGH] I1310.LCNS_NO ↔ I1300.LCNS_NO
...
-- -----------------------------------------------------------------------------
-- 23. [HIGH] I2832.LCNS_NO ↔ I2500.LCNS_NO
...
-- -----------------------------------------------------------------------------
-- 24. [HIGH] I0080.PRDLST_REPORT_NO ↔ I1310.PRDLST_REPORT_NO
...
-- -----------------------------------------------------------------------------
-- 25. [HIGH] I0490.LCNS_NO ↔ I1300.LCNS_NO
...
-- -----------------------------------------------------------------------------
-- 26. [SUGGESTED] I0310.PRDLST_REPORT_NO ↔ I0030.PRDLST_REPORT_NO
...
-- -----------------------------------------------------------------------------
-- 27. [SUGGESTED] I0080.LCNS_NO ↔ I1220.LCNS_NO
...
-- -----------------------------------------------------------------------------
-- 29. [HIGH] I2620.LCNS_NO ↔ I1300.LCNS_NO
...
-- -----------------------------------------------------------------------------
-- 30. [HIGH] I0460.PRDLST_REPORT_NO ↔ I1310.PRDLST_REPORT_NO
...
-- -----------------------------------------------------------------------------
-- 31. [HIGH] I1310.LCNS_NO ↔ I2500.LCNS_NO
...
-- -----------------------------------------------------------------------------
-- 32. [SUGGESTED] I0300.LCNS_NO ↔ I1220.LCNS_NO
...
-- -----------------------------------------------------------------------------
-- 34. [SUGGESTED] I0490.LCNS_NO ↔ I1260.LCNS_NO
...
-- -----------------------------------------------------------------------------
-- 35. [HIGH] I1250.LCNS_NO ↔ I2500.LCNS_NO
...
-- -----------------------------------------------------------------------------
-- 36. [HIGH] C002.PRDLST_REPORT_NO ↔ I1250.PRDLST_REPORT_NO
...
-- -----------------------------------------------------------------------------
-- 38. [SUGGESTED] I2852.LCNS_NO ↔ I1220.LCNS_NO
...
-- -----------------------------------------------------------------------------
-- 39. [SUGGESTED] I1540.LCNS_NO ↔ I1220.LCNS_NO
...
-- -----------------------------------------------------------------------------
-- 40. [SUGGESTED] I0680.LCNS_NO ↔ I1220.LCNS_NO
--   - 값 일치율 (Inclusion): 0.3% (2개 / Unique 747개)
--   - 실제 JOIN 레코드 수 : 2건 매칭됨
--   - 매칭된 샘플 데이터   : ["20140522061","20190533136"]
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- 41. [HIGH] I0580.LCNS_NO ↔ I2500.LCNS_NO
...
-- -----------------------------------------------------------------------------
-- 42. [HIGH] C003.PRDLST_REPORT_NO ↔ I0030.PRDLST_REPORT_NO
...
-- -----------------------------------------------------------------------------
-- 43. [HIGH] I2610.PRDLST_CD ↔ I2510.PRDLST_CD
...
-- -----------------------------------------------------------------------------
-- 44. [HIGH] C005.PRDLST_REPORT_NO ↔ I1310.PRDLST_REPORT_NO
...
-- -----------------------------------------------------------------------------
-- 45. [HIGH] I2859.LCNS_NO ↔ I2500.LCNS_NO
...
-- -----------------------------------------------------------------------------
-- 46. [HIGH] I0250.LCNS_NO ↔ I1260.LCNS_NO
...
-- -----------------------------------------------------------------------------
-- 47. [SUGGESTED] I0320.PRDLST_REPORT_NO ↔ I0030.PRDLST_REPORT_NO
...
-- -----------------------------------------------------------------------------
-- 48. [SUGGESTED] I0080.LCNS_NO ↔ I2500.LCNS_NO
