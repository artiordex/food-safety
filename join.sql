...
-- =========================================================================
-- [I2580] 개별기준규격  <==>  [I2530] 시험항목코드
-- 연결 매개체 : 시험항목코드 (TESTITM_CD)
-- 고유 매칭 건수 : 117 건 (중복 제거됨)
-- =========================================================================
SELECT DISTINCT
...
-- =========================================================================
-- [I2560] 영업소재지 GIS 코드  <==>  [I2500] 인허가 업소 정보
-- 연결 매개체 : 인허가번호 (LCNS_NO)
-- 고유 매칭 건수 : 999 건 (중복 제거됨)
-- =========================================================================
SELECT DISTINCT
    A."LCNS_NO" AS '매칭키_LCNS_NO',
    A.*, 
    B.*
FROM (SELECT * FROM "I2560" GROUP BY "LCNS_NO") A
INNER JOIN (SELECT * FROM "I2500" GROUP BY "LCNS_NO") B
    ON A."LCNS_NO" = B."LCNS_NO";


-- =========================================================================
-- [I2560] 영업소재지 GIS 코드  <==>  [I1300] 축산물 가공업허가정보
-- 연결 매개체 : 인허가번호 (LCNS_NO)
-- 고유 매칭 건수 : 3 건 (중복 제거됨)
-- =========================================================================
SELECT DISTINCT
...
-- =========================================================================
-- [I2560] 영업소재지 GIS 코드  <==>  [I1220] 식품제조가공업정보
-- 연결 매개체 : 인허가번호 (LCNS_NO)
-- 고유 매칭 건수 : 2 건 (중복 제거됨)
-- =========================================================================
SELECT DISTINCT
