...
CREATE TABLE "I2580" (
  ...
  "PRDLST_CD" VARCHAR(30), -- PRDLST_CD / 품목분류코드 / FK 후보(HIGH, 포함률 0.0%) -> I2510.PRDLST_CD
  "PRDLST_CD_NM" VARCHAR(200), -- PRDLST_CD_NM / 품목명
  "TESTITM_CD" VARCHAR(30), -- TESTITM_CD / 시험항목코드 / FK 후보(HIGH, 포함률 53.4%) -> I2530.TESTITM_CD
...
CREATE TABLE "I0960" (
  ...
  "TESTITM_CD" VARCHAR(30), -- TESTITM_CD / 시험항목코드 / FK 후보(HIGH, 포함률 60.9%) -> I2530.TESTITM_CD
...
-- -----------------------------------------------------------------------------
CREATE TABLE "I2857" (
  "LCNS_NO" VARCHAR(50), -- LCNS_NO / 인허가번호 / PK 후보(HIGH) / FK 후보(HIGH, 포함률 0.0%) -> I2500.LCNS_NO
  "BSSH_NM" VARCHAR(200), -- BSSH_NM / 업소명
  "PRSDNT_NM" VARCHAR(200), -- PRSDNT_NM / 대표자명
  "INDUTY_NM" VARCHAR(200), -- INDUTY_NM / 업종
  "PRMS_DT" DATE, -- PRMS_DT / 허가일자
...
CREATE TABLE "I2600" (
  ...
  "CMMN_SPEC_CD" VARCHAR(30), -- CMMN_SPEC_CD / 공통기준종류코드 / FK 후보(HIGH, 포함률 100.0%) -> I2590.CMMN_SPEC_CD
  "SPEC_NM" VARCHAR(200), -- SPEC_NM / 공통기준종류명
  "PRDLST_CD" VARCHAR(30), -- PRDLST_CD / 품목분류코드 / FK 후보(HIGH, 포함률 31.7%) -> I2510.PRDLST_CD
  "PRDLST_CD_NM" VARCHAR(200), -- PRDLST_CD_NM / 품목명
  "TESTITM_CD" VARCHAR(30), -- TESTITM_CD / 시험항목코드 / FK 후보(HIGH, 포함률 5.4%) -> I2530.TESTITM_CD
  "TESTITM_NM" VARCHAR(200), -- TESTITM_NM / 시험항목명
  "FNPRT_ITM_NM" VARCHAR(200), -- FNPRT_ITM_NM / 세부항목명
  "ATTRB_SEQ" NUMERIC(18,0), -- ATTRB_SEQ / 단서조항일련번호
  "PIAM_KOR_NM" VARCHAR(200), -- PIAM_KOR_NM / 단서조항명
...
CREATE TABLE "I2610" (
  ...
  "PRDLST_CD" VARCHAR(30), -- PRDLST_CD / 품목코드 / FK 후보(HIGH, 포함률 12.5%) -> I2510.PRDLST_CD
  "KOR_NM" VARCHAR(200), -- KOR_NM / 한글명
  "TESTITM_CD" VARCHAR(30), -- TESTITM_CD / 시험항목코드 / FK 후보(HIGH, 포함률 57.1%) -> I2530.TESTITM_CD
  "LAST_UPDT_DTM" DATE, -- LAST_UPDT_DTM / 최종수정일시
  FOREIGN KEY ("PRDLST_CD") REFERENCES "I2510" ("PRDLST_CD"),
  FOREIGN KEY ("TESTITM_CD") REFERENCES "I2530" ("TESTITM_CD")
);
...
-- -----------------------------------------------------------------------------
CREATE TABLE "I1250" (
  "LCNS_NO" VARCHAR(50), -- LCNS_NO / 인허가번호 / FK 후보(HIGH, 포함률 100.0%) -> I2500.LCNS_NO
  "BSSH_NM" VARCHAR(200), -- BSSH_NM / 업소명
  "PRDLST_REPORT_NO" VARCHAR(50), -- PRDLST_REPORT_NO / 품목제조번호 / PK 후보(HIGH)
  "PRMS_DT" DATE, -- PRMS_DT / 허가일자
  "PRDLST_NM" VARCHAR(200), -- PRDLST_NM / 제품명
...
CREATE TABLE "I0940" (
  "PRDLST_CD" VARCHAR(30), -- PRDLST_CD / 품목코드
  "PC_KOR_NM" VARCHAR(200), -- PC_KOR_NM / 품목한글명
  "TESTITM_CD" VARCHAR(30), -- TESTITM_CD / 시험항목코드 / FK 후보(HIGH, 포함률 16.9%) -> I2530.TESTITM_CD
  "T_KOR_NM" VARCHAR(200), -- T_KOR_NM / 시험항목 한글명
  "FNPRT_ITM_NM" VARCHAR(200), -- FNPRT_ITM_NM / 세부항목명
  "SPEC_VAL" VARCHAR(50), -- SPEC_VAL / 기준규격값
...
CREATE TABLE "C004" (
  ...
  "INDUTY_NM" VARCHAR(200), -- INDUTY_NM / 업종
  "LCNS_NO" VARCHAR(50), -- LCNS_NO / 인허가번호 / FK 후보(HIGH, 포함률 0.0%) -> I2713.LCNS_NO
  "BSSH_NM" VARCHAR(200), -- BSSH_NM / 업소명
  "PRSDNT_NM" VARCHAR(200), -- PRSDNT_NM / 대표자
  "ADDR" VARCHAR(500), -- ADDR / 주소
...
CREATE TABLE "I0950" (
  "PRDLST_CD" VARCHAR(30), -- PRDLST_CD / 품목코드
  "PC_KOR_NM" VARCHAR(200), -- PC_KOR_NM / 품목한글명
  "TESTITM_CD" VARCHAR(30), -- TESTITM_CD / 시험항목코드 / FK 후보(HIGH, 포함률 50.0%) -> I2530.TESTITM_CD
  "T_KOR_NM" VARCHAR(200), -- T_KOR_NM / 시험항목 한글명
  "FNPRT_ITM_NM" VARCHAR(200), -- FNPRT_ITM_NM / 세부항목명
  "SPEC_VAL" VARCHAR(50), -- SPEC_VAL / 기준규격값
...
-- -----------------------------------------------------------------------------
CREATE TABLE "I2832" (
  "LCNS_NO" VARCHAR(50), -- LCNS_NO / 인허가번호 / PK 후보(HIGH) / FK 후보(HIGH, 포함률 0.6%) -> I2500.LCNS_NO
  "BSSH_NM" VARCHAR(200), -- BSSH_NM / 업소명
  "PRSDNT_NM" VARCHAR(200), -- PRSDNT_NM / 대표자명
  "INDUTY_NM" VARCHAR(200), -- INDUTY_NM / 업종
  "PRMS_DT" DATE, -- PRMS_DT / 허가일자
...
CREATE TABLE "I0250" (
  ...
  "LCNS_NO" VARCHAR(50), -- LCNS_NO / 인허가번호 / FK 후보(HIGH, 포함률 2.5%) -> I1260.LCNS_NO
...
-- -----------------------------------------------------------------------------
CREATE TABLE "I2711" (
  "LCNS_NO" VARCHAR(50), -- LCNS_NO / 인허가번호 / FK 후보(HIGH, 포함률 78.4%) -> I2713.LCNS_NO
  "BSSH_NM" VARCHAR(200), -- BSSH_NM / 업소명
  "PRDLST_REPORT_NO" VARCHAR(50), -- PRDLST_REPORT_NO / 품목제조번호 / PK 후보(HIGH)
  "PRMS_DT" DATE, -- PRMS_DT / 허가일자
  "PRDLST_NM" VARCHAR(200), -- PRDLST_NM / 제품명
...
-- -----------------------------------------------------------------------------
CREATE TABLE "I2712" (
  "LCNS_NO" VARCHAR(50), -- LCNS_NO / 인허가번호 / FK 후보(HIGH, 포함률 70.6%) -> I2713.LCNS_NO
  "BSSH_NM" VARCHAR(200), -- BSSH_NM / 업소명
  "PRDLST_REPORT_NO" VARCHAR(50), -- PRDLST_REPORT_NO / 품목제조번호 / PK 후보(HIGH)
  "PRMS_DT" DATE, -- PRMS_DT / 보고일자
  "PRDLST_NM" VARCHAR(200), -- PRDLST_NM / 품목명
...
-- -----------------------------------------------------------------------------
CREATE TABLE "I1310" (
  "LCNS_NO" VARCHAR(50), -- LCNS_NO / 인허가번호 / FK 후보(HIGH, 포함률 100.0%) -> I1300.LCNS_NO
  "BSSH_NM" VARCHAR(200), -- BSSH_NM / 업소명
  "PRDLST_REPORT_NO" VARCHAR(50), -- PRDLST_REPORT_NO / 품목제조번호 / PK 후보(HIGH)
  "PRMS_DT" DATE, -- PRMS_DT / 보고일자
  "PRDLST_NM" VARCHAR(200), -- PRDLST_NM / 제품명
