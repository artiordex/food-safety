...
CREATE TABLE IF NOT EXISTS "I2580" (
  ...
  "PRDLST_CD" VARCHAR(500), -- PRDLST_CD / 품목분류코드 / FK 후보: I0950.PRDLST_CD(HIGH, 11.4%)
  ...
  FOREIGN KEY ("PRDLST_CD") REFERENCES "I0950" ("PRDLST_CD"),
...
CREATE TABLE IF NOT EXISTS "I2600" (
  ...
  "PRDLST_CD" VARCHAR(500), -- PRDLST_CD / 품목분류코드 / FK 후보: I2510.PRDLST_CD(HIGH, 31.7%), I0950.PRDLST_CD(HIGH, 0.7%)
  "PRDLST_CD_NM" VARCHAR(500), -- PRDLST_CD_NM / 품목명
...
CREATE TABLE IF NOT EXISTS "C005" (
  "PRDLST_REPORT_NO" VARCHAR(500), -- PRDLST_REPORT_NO / 품목보고(신고)번호 / PK 후보(HIGH) / FK 후보: I1310.PRDLST_REPORT_NO(HIGH, 0.1%)
...
CREATE TABLE IF NOT EXISTS "I2560" (
  "LCNS_NO" VARCHAR(500), -- LCNS_NO / 인허가번호 / PK 후보(HIGH) / FK 후보: I1300.LCNS_NO(HIGH, 0.3%), I2500.LCNS_NO(HIGH, 99.9%), I1220.LCNS_NO(HIGH, 0.2%)
  "BSSH_NM" VARCHAR(500), -- BSSH_NM / 업소명
...
CREATE TABLE IF NOT EXISTS "I2640" (
  ...
  "BRCDNO" VARCHAR(500), -- BRCDNO / 바코드번호 / PK 후보(HIGH) / FK 후보: I2620.BRCDNO(HIGH, 100.0%), I0490.BRCDNO(HIGH, 50.0%)
...
CREATE TABLE IF NOT EXISTS "I0460" (
  ...
  "PRDLST_REPORT_NO" VARCHAR(500), -- PRDLST_REPORT_NO / 품목제조보고번호 / PK 후보(HIGH) / FK 후보: I2711.PRDLST_REPORT_NO(HIGH, 2.3%), I1310.PRDLST_REPORT_NO(HIGH, 0.3%)
  "LAST_UPDT_DTM" VARCHAR(500), -- LAST_UPDT_DTM / 최종수정일시
...
CREATE TABLE IF NOT EXISTS "I0320" (
  ...
  "PRDLST_REPORT_NO" VARCHAR(500), -- PRDLST_REPORT_NO / 품목보고번호 / PK 후보(HIGH) / FK 후보: I0030.PRDLST_REPORT_NO(HIGH, 0.2%)
...
CREATE TABLE IF NOT EXISTS "I2846" (
  ...
  "REPORT_YR" VARCHAR(500), -- REPORT_YR / 년도 / PK 후보(MEDIUM)
...
CREATE TABLE IF NOT EXISTS "I0080" (
  ...
  "BSSH_NM" VARCHAR(500), -- BSSH_NM / 업소명
  "LCNS_NO" VARCHAR(500), -- LCNS_NO / 인허가번호 / FK 후보: I1300.LCNS_NO(HIGH, 11.1%), I2500.LCNS_NO(HIGH, 0.5%), I1220.LCNS_NO(HIGH, 2.3%)
  ...
  "PRDLST_REPORT_NO" VARCHAR(500), -- PRDLST_REPORT_NO / 품목보고번호 / FK 후보: I1310.PRDLST_REPORT_NO(HIGH, 0.7%)
...
CREATE TABLE IF NOT EXISTS "I0580" (
  "LCNS_NO" VARCHAR(500), -- LCNS_NO / 인허가번호 / PK 후보(HIGH) / FK 후보: I2500.LCNS_NO(HIGH, 0.2%), I1220.LCNS_NO(HIGH, 4.9%)
...
CREATE TABLE IF NOT EXISTS "I0610" (
  "LCNS_NO" VARCHAR(500), -- LCNS_NO / 인허가번호 / PK 후보(HIGH) / FK 후보: I1300.LCNS_NO(HIGH, 9.5%)
  "BSSH_NM" VARCHAR(500), -- BSSH_NM / 업소명
...
CREATE TABLE IF NOT EXISTS "I2851" (
  ...
  "PRDLST_REPORT_NO" VARCHAR(500), -- PRDLST_REPORT_NO / 품목제조보고번호 / PK 후보(HIGH) / FK 후보: I2711.PRDLST_REPORT_NO(HIGH, 2.8%)
...
CREATE TABLE IF NOT EXISTS "I2859" (
  "BSSH_NM" VARCHAR(500), -- BSSH_NM / 업소명
  "INDUTY_CD_NM" VARCHAR(500), -- INDUTY_CD_NM / 업종
  "LCNS_NO" VARCHAR(500), -- LCNS_NO / 인허가번호 / PK 후보(HIGH) / FK 후보: I2500.LCNS_NO(HIGH, 0.3%), I1220.LCNS_NO(HIGH, 100.0%)
  "TELNO" VARCHAR(500), -- TELNO / 전화번호
  "SITE_ADDR" VARCHAR(500), -- SITE_ADDR / 주소
  "CHNG_DT" VARCHAR(500), -- CHNG_DT / 변경일자
  "CHNG_BF_CN" VARCHAR(500), -- CHNG_BF_CN / 변경전내용
...
CREATE TABLE IF NOT EXISTS "I1540" (
  ...
  "LCNS_NO" VARCHAR(500), -- LCNS_NO / 인허가번호 / FK 후보: I1220.LCNS_NO(HIGH, 0.3%)
  "BSSH_NM" VARCHAR(500), -- BSSH_NM / 업체명
  "PRSDNT_NM" VARCHAR(500), -- PRSDNT_NM / 대표자
  "ADDR" VARCHAR(500), -- ADDR / 주소
...
CREATE TABLE IF NOT EXISTS "I0680" (
  "LCNS_NO" VARCHAR(500), -- LCNS_NO / 인허가번호 / PK 후보(HIGH) / FK 후보: I1220.LCNS_NO(HIGH, 0.3%)
  "BSSH_NM" VARCHAR(500), -- BSSH_NM / 업소명
...
CREATE TABLE IF NOT EXISTS "I2620" (
  ...
  "INSTT_NM" VARCHAR(500), -- INSTT_NM / 검사기관
  "REGSTR_TELNO" VARCHAR(500), -- REGSTR_TELNO / 전화번호
  "BRCDNO" VARCHAR(500), -- BRCDNO / 바코드번호 / PK 후보(HIGH) / FK 후보: I0490.BRCDNO(HIGH, 44.1%)
  "FRMLCUNIT" VARCHAR(500), -- FRMLCUNIT / 포장단위
  "TEST_ITMNM" VARCHAR(500), -- TEST_ITMNM / 부적합항목
  "STDR_STND" VARCHAR(500), -- STDR_STND / 기준규격
  "TESTANALS_RSLT" VARCHAR(500), -- TESTANALS_RSLT / 검사결과
...
CREATE TABLE IF NOT EXISTS "I1310" (
  "LCNS_NO" VARCHAR(500), -- LCNS_NO / 인허가번호 / FK 후보: I1300.LCNS_NO(HIGH, 100.0%), I2500.LCNS_NO(HIGH, 30.0%)
  "BSSH_NM" VARCHAR(500), -- BSSH_NM / 업소명
  "PRDLST_REPORT_NO" VARCHAR(500), -- PRDLST_REPORT_NO / 품목제조번호 / PK 후보(HIGH)
  "PRMS_DT" VARCHAR(500), -- PRMS_DT / 보고일자
  "PRDLST_NM" VARCHAR(500), -- PRDLST_NM / 제품명
...
CREATE TABLE IF NOT EXISTS "I0490" (
  ...
  "LCNS_NO" VARCHAR(500), -- LCNS_NO / 업체인허가번호 / FK 후보: I1300.LCNS_NO(HIGH, 2.3%), I1260.LCNS_NO(HIGH, 1.4%), I1220.LCNS_NO(HIGH, 0.5%)
  PRIMARY KEY ("BRCDNO"),
  FOREIGN KEY ("PRDLST_CD") REFERENCES "I2510" ("PRDLST_CD"),
  FOREIGN KEY ("LCNS_NO") REFERENCES "I1300" ("LCNS_NO"),
  FOREIGN KEY ("LCNS_NO") REFERENCES "I1260" ("LCNS_NO"),
...
CREATE TABLE IF NOT EXISTS "I2852" (
  "PRDLST_REPORT_NO" VARCHAR(500), -- PRDLST_REPORT_NO / 품목제조보고번호 / PK 후보(HIGH) / FK 후보: I0030.PRDLST_REPORT_NO(HIGH, 0.1%)
  "PRMS_DT" VARCHAR(500), -- PRMS_DT / 품목보고일자
  "PRDLST_NM" VARCHAR(500), -- PRDLST_NM / 제품명
  "END_DT" VARCHAR(500), -- END_DT / 생산중단일자
  "PRDLST_DCNM" VARCHAR(500), -- PRDLST_DCNM / 품목유형명
  "LCNS_NO" VARCHAR(500), -- LCNS_NO / 인허가번호 / FK 후보: I1300.LCNS_NO(HIGH, 4.2%), I1220.LCNS_NO(HIGH, 4.2%)
  "BSSH_NM" VARCHAR(500), -- BSSH_NM / 업소명
...
CREATE TABLE IF NOT EXISTS "I2712" (
  "LCNS_NO" VARCHAR(500), -- LCNS_NO / 인허가번호 / FK 후보: I2713.LCNS_NO(HIGH, 70.8%)
  "BSSH_NM" VARCHAR(500), -- BSSH_NM / 업소명
  "PRDLST_REPORT_NO" VARCHAR(500), -- PRDLST_REPORT_NO / 품목제조번호 / PK 후보(HIGH) / FK 후보: I2711.PRDLST_REPORT_NO(HIGH, 4.9%)
  "PRMS_DT" VARCHAR(500), -- PRMS_DT / 보고일자
  "PRDLST_NM" VARCHAR(500), -- PRDLST_NM / 품목명
  "PRDLST_DCNM" VARCHAR(500), -- PRDLST_DCNM / 유형
  "RAWMTRL_NM" VARCHAR(500), -- RAWMTRL_NM / 원재료
...
CREATE TABLE IF NOT EXISTS "I0310" (
  ...
  "LCNS_NO" VARCHAR(500), -- LCNS_NO / 인허가번호
  "EVL_YR" VARCHAR(500), -- EVL_YR / 보고년도
  "PRDLST_REPORT_NO" VARCHAR(500), -- PRDLST_REPORT_NO / 품목제조보고번호 / PK 후보(HIGH) / FK 후보: I0030.PRDLST_REPORT_NO(HIGH, 0.5%)
  "FYER_PRDCTN_ABRT_QY" VARCHAR(500), -- FYER_PRDCTN_ABRT_QY / 연간생산능력(KG)
  "PRDCTN_QY" VARCHAR(500), -- PRDCTN_QY / 생산량(KG)
  PRIMARY KEY ("PRDLST_REPORT_NO"),
  FOREIGN KEY ("PRDLST_REPORT_NO") REFERENCES "I0030" ("PRDLST_REPORT_NO")
...
CREATE TABLE IF NOT EXISTS "C003" (
  "LCNS_NO" VARCHAR(500), -- LCNS_NO / 인허가번호
  "BSSH_NM" VARCHAR(500), -- BSSH_NM / 업소명
  "PRDLST_REPORT_NO" VARCHAR(500), -- PRDLST_REPORT_NO / 품목제조번호 / PK 후보(HIGH) / FK 후보: I0030.PRDLST_REPORT_NO(HIGH, 0.1%)
  "PRDLST_NM" VARCHAR(500), -- PRDLST_NM / 품목명
  "PRMS_DT" VARCHAR(500), -- PRMS_DT / 보고일자
  "POG_DAYCNT" VARCHAR(500), -- POG_DAYCNT / 소비기한
...
CREATE TABLE IF NOT EXISTS "C002" (
  ...
  "BSSH_NM" VARCHAR(500), -- BSSH_NM / 업소명
  "PRDLST_REPORT_NO" VARCHAR(500), -- PRDLST_REPORT_NO / 품목제조번호 / PK 후보(HIGH) / FK 후보: I1250.PRDLST_REPORT_NO(HIGH, 0.2%)
  "PRMS_DT" VARCHAR(500), -- PRMS_DT / 보고일자
  "PRDLST_NM" VARCHAR(500), -- PRDLST_NM / 품목명
  "PRDLST_DCNM" VARCHAR(500), -- PRDLST_DCNM / 품목유형명
  "RAWMTRL_NM" VARCHAR(500), -- RAWMTRL_NM / 원재료명
...
CREATE TABLE IF NOT EXISTS "I0480" (
  "PRCSCITYPOINT_BSSHNM" VARCHAR(500), -- PRCSCITYPOINT_BSSHNM / 업소명
  "INDUTY_CD_NM" VARCHAR(500), -- INDUTY_CD_NM / 업종
  "LCNS_NO" VARCHAR(500), -- LCNS_NO / 인허가번호 / PK 후보(HIGH) / FK 후보: I1220.LCNS_NO(HIGH, 0.8%)
  "DSPS_DCSNDT" VARCHAR(500), -- DSPS_DCSNDT / 처분확정일자
  "DSPS_BGNDT" VARCHAR(500), -- DSPS_BGNDT / 처분시작일(영업정지의경우)
  "DSPS_ENDDT" VARCHAR(500), -- DSPS_ENDDT / 처분종료일(영업정지의경우)
  "DSPS_TYPECD_NM" VARCHAR(500), -- DSPS_TYPECD_NM / 처분유형
...
-- FK 후보 [HIGH/100] "I2580"."PRDLST_CD" -> "I0950"."PRDLST_CD"
-- 값 포함률: 11.4% (21/185)
-- 사유: 대상 테이블 I0950의 PK 후보(MEDIUM)와 동일 필드 / 공통 관계키 목록에 포함 / 코드 계열 필드 / 대표 마스터 테이블 규칙 적용 / 값 포함률 11.4%
-- FOREIGN KEY ("PRDLST_CD") REFERENCES "I0950" ("PRDLST_CD")
...
-- FK 후보 [HIGH/100] "I2600"."PRDLST_CD" -> "I0950"."PRDLST_CD"
-- 값 포함률: 0.7% (1/139)
-- 사유: 대상 테이블 I0950의 PK 후보(MEDIUM)와 동일 필드 / 공통 관계키 목록에 포함 / 코드 계열 필드 / 대표 마스터 테이블 규칙 적용 / 값 포함률 0.7%
-- FOREIGN KEY ("PRDLST_CD") REFERENCES "I0950" ("PRDLST_CD")
...
-- 값 포함률: 0.2% (2/1000)
-- 사유: 대상 테이블 I1220의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 업무 명칭 규칙: "영업소재지 GIS 코드" → "식품제조가공업정보" 부모-자식 관계 확인 / 값 포함률 0.2%
-- FOREIGN KEY ("LCNS_NO") REFERENCES "I1220" ("LCNS_NO")
...
-- 값 포함률: 50.0% (8/16)
-- 사유: 대상 테이블 I0490의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 값 포함률 50.0%
-- FOREIGN KEY ("BRCDNO") REFERENCES "I0490" ("BRCDNO")

-- FK 후보 [HIGH/100] "I2620"."BRCDNO" -> "I0490"."BRCDNO"
-- 값 포함률: 44.1% (26/59)
-- 사유: 대상 테이블 I0490의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 값 포함률 44.1%
-- FOREIGN KEY ("BRCDNO") REFERENCES "I0490" ("BRCDNO")
...
-- 값 포함률: 2.3% (7/300)
-- 사유: 대상 테이블 I2711의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 업무 명칭 규칙: "수거검사 계획 및 실적 관련 현황" → "위생용품품목제조보고" 부모-자식 관계 확인 / 값 포함률 2.3%
-- FOREIGN KEY ("PRDLST_REPORT_NO") REFERENCES "I2711" ("PRDLST_REPORT_NO")

-- FK 후보 [HIGH/100] "I0460"."PRDLST_REPORT_NO" -> "I1310"."PRDLST_REPORT_NO"
-- 값 포함률: 0.3% (1/300)
-- 사유: 대상 테이블 I1310의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 업무 명칭 규칙: "수거검사 계획 및 실적 관련 현황" → "축산물 품목제조정보" 부모-자식 관계 확인 / 값 포함률 0.3%
-- FOREIGN KEY ("PRDLST_REPORT_NO") REFERENCES "I1310" ("PRDLST_REPORT_NO")
...
-- 값 포함률: 2.3% (5/217)
-- 사유: 대상 테이블 I1220의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 업무 명칭 규칙: "어린이 기호식품 품질인증 현황 및 재심사 현황" → "식품제조가공업정보" 부모-자식 관계 확인 / 값 포함률 2.3%
-- FOREIGN KEY ("LCNS_NO") REFERENCES "I1220" ("LCNS_NO")
...
-- 값 포함률: 4.9% (32/657)
-- 사유: 대상 테이블 I1220의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 업무 명칭 규칙: "HACCP 적용업소 지정 현황" → "식품제조가공업정보" 부모-자식 관계 확인 / 값 포함률 4.9%
-- FOREIGN KEY ("LCNS_NO") REFERENCES "I1220" ("LCNS_NO")

-- FK 후보 [HIGH/100] "I0610"."LCNS_NO" -> "I1300"."LCNS_NO"
-- 값 포함률: 9.5% (92/973)
-- 사유: 대상 테이블 I1300의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 데이터셋명 도메인 유사성 +10 / 업무 명칭 규칙: "축산물HACCP 지정정보" → "축산물 가공업허가정보" 부모-자식 관계 확인 / 값 포함률 9.5%
-- FOREIGN KEY ("LCNS_NO") REFERENCES "I1300" ("LCNS_NO")

-- FK 후보 [HIGH/100] "I2852"."PRDLST_REPORT_NO" -> "I0030"."PRDLST_REPORT_NO"
-- 값 포함률: 0.1% (1/1000)
-- 사유: 대상 테이블 I0030의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 값 포함률 0.1%
-- FOREIGN KEY ("PRDLST_REPORT_NO") REFERENCES "I0030" ("PRDLST_REPORT_NO")

-- FK 후보 [HIGH/100] "I2852"."LCNS_NO" -> "I1300"."LCNS_NO"
-- 값 포함률: 4.2% (5/120)
-- 사유: 대상 테이블 I1300의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 업무 명칭 규칙: "생산중단제품정보" → "축산물 가공업허가정보" 부모-자식 관계 확인 / 값 포함률 4.2%
-- FOREIGN KEY ("LCNS_NO") REFERENCES "I1300" ("LCNS_NO")

-- FK 후보 [HIGH/100] "I2852"."LCNS_NO" -> "I1220"."LCNS_NO"
-- 값 포함률: 4.2% (5/120)
-- 사유: 대상 테이블 I1220의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 업무 명칭 규칙: "생산중단제품정보" → "식품제조가공업정보" 부모-자식 관계 확인 / 값 포함률 4.2%
-- FOREIGN KEY ("LCNS_NO") REFERENCES "I1220" ("LCNS_NO")
...
-- 값 포함률: 70.8% (114/161)
-- 사유: 대상 테이블 I2713의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 데이터셋명 도메인 유사성 +10 / 값 포함률 70.8%
-- FOREIGN KEY ("LCNS_NO") REFERENCES "I2713" ("LCNS_NO")
...
-- 값 포함률: 5.6% (3/54)
-- 사유: 대상 테이블 I1220의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 데이터셋명 도메인 유사성 +10 / 업무 명칭 규칙: "식품.식품첨가물 생산실적 보고 현황" → "식품제조가공업정보" 부모-자식 관계 확인 / 값 포함률 5.6%
-- FOREIGN KEY ("LCNS_NO") REFERENCES "I1220" ("LCNS_NO")
...
-- 값 포함률: 0.3% (2/756)
-- 사유: 대상 테이블 I1220의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 업무 명칭 규칙: "식품위생등급평가관리내역" → "식품제조가공업정보" 부모-자식 관계 확인 / 값 포함률 0.3%
-- FOREIGN KEY ("LCNS_NO") REFERENCES "I1220" ("LCNS_NO")
...
-- 값 포함률: 1.4% (3/221)
-- 사유: 대상 테이블 I1260의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 업무 명칭 규칙: "회수.판매중지 정보" → "식품등수입판매업정보" 부모-자식 관계 확인 / 값 포함률 1.4%
-- FOREIGN KEY ("LCNS_NO") REFERENCES "I1260" ("LCNS_NO")

-- FK 후보 [HIGH/100] "I0490"."LCNS_NO" -> "I1220"."LCNS_NO"
-- 값 포함률: 0.5% (1/221)
-- 사유: 대상 테이블 I1220의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 업무 명칭 규칙: "회수.판매중지 정보" → "식품제조가공업정보" 부모-자식 관계 확인 / 값 포함률 0.5%
-- FOREIGN KEY ("LCNS_NO") REFERENCES "I1220" ("LCNS_NO")

-- FK 후보 [HIGH/100] "C004"."LCNS_NO" -> "I1200"."LCNS_NO"
-- 값 포함률: 0.3% (3/1000)
-- 사유: 대상 테이블 I1200의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 데이터셋명 도메인 유사성 +10 / 업무 명칭 규칙: "식품접객업소 위생등급 지정현황" → "식품접객업정보" 부모-자식 관계 확인 / 값 포함률 0.3%
-- FOREIGN KEY ("LCNS_NO") REFERENCES "I1200" ("LCNS_NO")
...
-- 값 포함률: 0.3% (2/756)
-- 사유: 대상 테이블 I1220의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 업무 명칭 규칙: "위생관리등급별 업소 현황" → "식품제조가공업정보" 부모-자식 관계 확인 / 값 포함률 0.3%
-- FOREIGN KEY ("LCNS_NO") REFERENCES "I1220" ("LCNS_NO")

-- FK 후보 [HIGH/100] "I2861"."LCNS_NO" -> "I1200"."LCNS_NO"
-- 값 포함률: 100.0% (157/157)
-- 사유: 대상 테이블 I1200의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 데이터셋명 도메인 유사성 +10 / 업무 명칭 규칙: "음식점업소 인허가 변경 정보" → "식품접객업정보" 부모-자식 관계 확인 / 값 포함률 100.0%
-- FOREIGN KEY ("LCNS_NO") REFERENCES "I1200" ("LCNS_NO")
...
-- 제외 FK 후보 "I0960"."PRDLST_CD" -> "I0950"."PRDLST_CD"
-- 값 포함률: 0.0% (0/330)
-- 제외 사유: 데이터가 없거나 조인(교집합)되는 값이 없음
...
-- 제외 FK 후보 "I2610"."PRDLST_CD" -> "I0950"."PRDLST_CD"
-- 값 포함률: 0.0% (0/8)
-- 제외 사유: 데이터가 없거나 조인(교집합)되는 값이 없음
...
-- 제외 FK 후보 "I2560"."LCNS_NO" -> "I1200"."LCNS_NO"
-- 값 포함률: 0.0% (0/1000)
-- 제외 사유: 데이터가 없거나 조인(교집합)되는 값이 없음
...
-- 제외 FK 후보 "I2640"."LCNS_NO" -> "I1200"."LCNS_NO"
-- 값 포함률: 0.0% (0/12)
-- 제외 사유: 데이터가 없거나 조인(교집합)되는 값이 없음
...
-- 제외 FK 후보 "I2620"."LCNS_NO" -> "I1200"."LCNS_NO"
-- 값 포함률: 0.0% (0/85)
-- 제외 사유: 데이터가 없거나 조인(교집합)되는 값이 없음
...
-- 제외 FK 후보 "I2854"."PRDLST_CD" -> "I0950"."PRDLST_CD"
-- 값 포함률: 0.0% (0/382)
-- 제외 사유: 데이터가 없거나 조인(교집합)되는 값이 없음
...
-- 제외 FK 후보 "I0580"."LCNS_NO" -> "I1200"."LCNS_NO"
-- 값 포함률: 0.0% (0/657)
-- 제외 사유: 데이터가 없거나 조인(교집합)되는 값이 없음
...
-- 제외 FK 후보 "I2857"."LCNS_NO" -> "I1200"."LCNS_NO"
-- 값 포함률: 0.0% (0/78)
-- 제외 사유: 데이터가 없거나 조인(교집합)되는 값이 없음
...
-- 제외 FK 후보 "I2852"."LCNS_NO" -> "I1200"."LCNS_NO"
-- 값 포함률: 0.0% (0/120)
-- 제외 사유: 데이터가 없거나 조인(교집합)되는 값이 없음
...
-- 제외 FK 후보 "I2847"."LCNS_NO" -> "I1200"."LCNS_NO"
-- 값 포함률: 0.0% (0/989)
-- 제외 사유: 데이터가 없거나 조인(교집합)되는 값이 없음
...
-- 제외 FK 후보 "I2859"."LCNS_NO" -> "I1200"."LCNS_NO"
-- 값 포함률: 0.0% (0/343)
-- 제외 사유: 데이터가 없거나 조인(교집합)되는 값이 없음
...
-- 제외 FK 후보 "I1560"."LCNS_NO" -> "I1200"."LCNS_NO"
-- 값 포함률: 0.0% (0/1)
-- 제외 사유: 데이터가 없거나 조인(교집합)되는 값이 없음
...
-- 제외 FK 후보 "I1540"."LCNS_NO" -> "I1200"."LCNS_NO"
-- 값 포함률: 0.0% (0/756)
-- 제외 사유: 데이터가 없거나 조인(교집합)되는 값이 없음
...
-- 제외 FK 후보 "I2817"."LCNS_NO" -> "I1200"."LCNS_NO"
-- 값 포함률: 0.0% (0/600)
-- 제외 사유: 데이터가 없거나 조인(교집합)되는 값이 없음
...
-- 제외 FK 후보 "I2819"."LCNS_NO" -> "I1200"."LCNS_NO"
-- 값 포함률: 0.0% (0/1000)
-- 제외 사유: 데이터가 없거나 조인(교집합)되는 값이 없음
...
-- 제외 FK 후보 "I0940"."PRDLST_CD" -> "I0950"."PRDLST_CD"
-- 값 포함률: 0.0% (0/56)
-- 제외 사유: 데이터가 없거나 조인(교집합)되는 값이 없음
...
-- 제외 FK 후보 "I1101"."PRDLST_CD" -> "I0950"."PRDLST_CD"
-- 값 포함률: 미검증
-- 제외 사유: 데이터가 없거나 조인(교집합)되는 값이 없음
...
-- 제외 FK 후보 "I0470"."LCNS_NO" -> "I1200"."LCNS_NO"
-- 값 포함률: 0.0% (0/989)
-- 제외 사유: 데이터가 없거나 조인(교집합)되는 값이 없음
...
-- 제외 FK 후보 "I2630"."LCNS_NO" -> "I1200"."LCNS_NO"
-- 값 포함률: 0.0% (0/992)
-- 제외 사유: 데이터가 없거나 조인(교집합)되는 값이 없음
...
-- 제외 FK 후보 "I0490"."PRDLST_CD" -> "I0950"."PRDLST_CD"
-- 값 포함률: 0.0% (0/119)
-- 제외 사유: 데이터가 없거나 조인(교집합)되는 값이 없음
...
-- 제외 FK 후보 "I0490"."LCNS_NO" -> "I1200"."LCNS_NO"
-- 값 포함률: 0.0% (0/221)
-- 제외 사유: 데이터가 없거나 조인(교집합)되는 값이 없음
...
-- 제외 FK 후보 "I2834"."LCNS_NO" -> "I1200"."LCNS_NO"
-- 값 포함률: 0.0% (0/1000)
-- 제외 사유: 데이터가 없거나 조인(교집합)되는 값이 없음
...
-- 제외 FK 후보 "I2856"."LCNS_NO" -> "I1200"."LCNS_NO"
-- 값 포함률: 0.0% (0/1000)
-- 제외 사유: 데이터가 없거나 조인(교집합)되는 값이 없음
...
-- 제외 FK 후보 "I0680"."LCNS_NO" -> "I1200"."LCNS_NO"
-- 값 포함률: 0.0% (0/756)
-- 제외 사유: 데이터가 없거나 조인(교집합)되는 값이 없음
...
-- 제외 FK 후보 "I2820"."LCNS_NO" -> "I1200"."LCNS_NO"
-- 값 포함률: 0.0% (0/1000)
-- 제외 사유: 데이터가 없거나 조인(교집합)되는 값이 없음
