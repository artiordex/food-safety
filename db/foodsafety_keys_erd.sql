...
CREATE TABLE IF NOT EXISTS "I0490" (
  ...
  "BRCDNO" VARCHAR(500), -- BRCDNO / 바코드번호 / PK 후보(HIGH)
...
CREATE TABLE IF NOT EXISTS "I2620" (
  ...
  "BRCDNO" VARCHAR(500), -- BRCDNO / 바코드번호 / PK 후보(HIGH) / FK 후보: I0490.BRCDNO(HIGH, 41.4%)
  "FRMLCUNIT" VARCHAR(500), -- FRMLCUNIT / 포장단위
  ...
  "PRDLST_REPORT_NO" VARCHAR(500), -- PRDLST_REPORT_NO / 품목제조보고번호 / FK 후보: I2711.PRDLST_REPORT_NO(HIGH, 0.0%), I1310.PRDLST_REPORT_NO(HIGH, 0.0%)
  "LCNS_NO" VARCHAR(500), -- LCNS_NO / 업체인허가번호 / FK 후보: I2500.LCNS_NO(HIGH, 0.0%), I2713.LCNS_NO(HIGH, 0.0%)
...
CREATE TABLE IF NOT EXISTS "I2826" (
  "LCNS_NO" VARCHAR(500), -- LCNS_NO / 인허가번호 / PK 후보(HIGH) / FK 후보: I2500.LCNS_NO(HIGH, 0.0%), I1300.LCNS_NO(HIGH, 0.0%)
  "BSSH_NM" VARCHAR(500), -- BSSH_NM / 업소명
  "PRSDNT_NM" VARCHAR(500), -- PRSDNT_NM / 대표자명
  "INDUTY_NM" VARCHAR(500), -- INDUTY_NM / 업종
  "PRMS_DT" VARCHAR(500), -- PRMS_DT / 허가일자
...
CREATE TABLE IF NOT EXISTS "I2837" (
  "WORD" VARCHAR(500), -- WORD / 단어 / PK 후보(MEDIUM)
...
CREATE TABLE IF NOT EXISTS "I2812" (
  "LCNS_NO" VARCHAR(500), -- LCNS_NO / 인허가번호 / PK 후보(HIGH) / FK 후보: I2500.LCNS_NO(HIGH, 0.0%), I1220.LCNS_NO(HIGH, 0.0%)
  "BSSH_NM" VARCHAR(500), -- BSSH_NM / 업소명
  "PRSDNT_NM" VARCHAR(500), -- PRSDNT_NM / 대표자명
  "INDUTY_NM" VARCHAR(500), -- INDUTY_NM / 업종
  "PRMS_DT" VARCHAR(500), -- PRMS_DT / 허가일자
...
CREATE TABLE IF NOT EXISTS "I2819" (
  "LCNS_NO" VARCHAR(500), -- LCNS_NO / 인허가번호 / PK 후보(HIGH) / FK 후보: I2500.LCNS_NO(HIGH, 0.0%), I1200.LCNS_NO(HIGH, 0.0%)
  "BSSH_NM" VARCHAR(500), -- BSSH_NM / 업소명
  "PRSDNT_NM" VARCHAR(500), -- PRSDNT_NM / 대표자명
  "INDUTY_NM" VARCHAR(500), -- INDUTY_NM / 업종
  "PRMS_DT" VARCHAR(500), -- PRMS_DT / 허가일자
...
CREATE TABLE IF NOT EXISTS "I2780" (
  "MEATWATCH_NO" VARCHAR(500), -- MEATWATCH_NO / 이력번호 / PK 후보(HIGH)
...
CREATE TABLE IF NOT EXISTS "I2816" (
  "LCNS_NO" VARCHAR(500), -- LCNS_NO / 인허가번호 / PK 후보(HIGH) / FK 후보: I2500.LCNS_NO(HIGH, 0.0%), I2713.LCNS_NO(HIGH, 0.0%)
  "BSSH_NM" VARCHAR(500), -- BSSH_NM / 업소명
  "PRSDNT_NM" VARCHAR(500), -- PRSDNT_NM / 대표자명
  "INDUTY_NM" VARCHAR(500), -- INDUTY_NM / 업종
  "PRMS_DT" VARCHAR(500), -- PRMS_DT / 허가일자
...
CREATE TABLE IF NOT EXISTS "I2818" (
  "LCNS_NO" VARCHAR(500), -- LCNS_NO / 인허가번호 / PK 후보(HIGH) / FK 후보: I2500.LCNS_NO(HIGH, 0.0%)
  "BSSH_NM" VARCHAR(500), -- BSSH_NM / 업소명
  "PRSDNT_NM" VARCHAR(500), -- PRSDNT_NM / 대표자명
  "INDUTY_NM" VARCHAR(500), -- INDUTY_NM / 업종
  "PRMS_DT" VARCHAR(500), -- PRMS_DT / 허가일자
...
CREATE TABLE IF NOT EXISTS "I2821" (
  "LCNS_NO" VARCHAR(500), -- LCNS_NO / 인허가번호 / PK 후보(HIGH) / FK 후보: I2500.LCNS_NO(HIGH, 0.0%), I1260.LCNS_NO(HIGH, 0.0%)
  "BSSH_NM" VARCHAR(500), -- BSSH_NM / 업소명
  "PRSDNT_NM" VARCHAR(500), -- PRSDNT_NM / 대표자명
  "INDUTY_NM" VARCHAR(500), -- INDUTY_NM / 업종
  "PRMS_DT" VARCHAR(500), -- PRMS_DT / 허가일자
...
CREATE TABLE IF NOT EXISTS "I0680" (
  "LCNS_NO" VARCHAR(500), -- LCNS_NO / 인허가번호 / PK 후보(HIGH) / FK 후보: I2713.LCNS_NO(HIGH, 0.0%), I1260.LCNS_NO(HIGH, 0.0%)
  "BSSH_NM" VARCHAR(500), -- BSSH_NM / 업소명
...
CREATE TABLE IF NOT EXISTS "I2861" (
  ...
  "LCNS_NO" VARCHAR(500), -- LCNS_NO / 인허가번호 / PK 후보(HIGH) / FK 후보: I2500.LCNS_NO(HIGH, 0.0%), I1200.LCNS_NO(HIGH, 100.0%)
  "TELNO" VARCHAR(500), -- TELNO / 전화번호
...
CREATE TABLE IF NOT EXISTS "C004" (
  ...
  "INDUTY_NM" VARCHAR(500), -- INDUTY_NM / 업종
  "LCNS_NO" VARCHAR(500), -- LCNS_NO / 인허가번호 / FK 후보: I1200.LCNS_NO(HIGH, 0.3%)
  "BSSH_NM" VARCHAR(500), -- BSSH_NM / 업소명
  "PRSDNT_NM" VARCHAR(500), -- PRSDNT_NM / 대표자
  "ADDR" VARCHAR(500), -- ADDR / 주소
...
CREATE TABLE IF NOT EXISTS "I1550" (
  "BSSH_NM" VARCHAR(500), -- BSSH_NM / 업소명
  "ZIPNO" VARCHAR(500), -- ZIPNO / 우편번호 / PK 후보(MEDIUM)
  "LOCP_ADDR" VARCHAR(500), -- LOCP_ADDR / 주소
...
CREATE TABLE IF NOT EXISTS "I1230" (
  "LCNS_NO" VARCHAR(500), -- LCNS_NO / 인허가 번호 / PK 후보(HIGH) / FK 후보: I2500.LCNS_NO(HIGH, 1.2%)
  "BSSH_NM" VARCHAR(500), -- BSSH_NM / 업소명
  "PRSDNT_NM" VARCHAR(500), -- PRSDNT_NM / 대표자명
  "INDUTY_NM" VARCHAR(500), -- INDUTY_NM / 업종
  "PRMS_DT" VARCHAR(500), -- PRMS_DT / 허가일자
...
CREATE TABLE IF NOT EXISTS "I1540" (
  ...
  "LCNS_NO" VARCHAR(500), -- LCNS_NO / 인허가번호 / FK 후보: I2713.LCNS_NO(HIGH, 0.0%), I1300.LCNS_NO(HIGH, 0.0%)
  "BSSH_NM" VARCHAR(500), -- BSSH_NM / 업체명
  "PRSDNT_NM" VARCHAR(500), -- PRSDNT_NM / 대표자
  "ADDR" VARCHAR(500), -- ADDR / 주소
...
CREATE TABLE IF NOT EXISTS "I2859" (
  ...
  "LCNS_NO" VARCHAR(500), -- LCNS_NO / 인허가번호 / PK 후보(HIGH) / FK 후보: I2500.LCNS_NO(HIGH, 0.3%), I2713.LCNS_NO(HIGH, 0.0%)
  "TELNO" VARCHAR(500), -- TELNO / 전화번호
  "SITE_ADDR" VARCHAR(500), -- SITE_ADDR / 주소
  "CHNG_DT" VARCHAR(500), -- CHNG_DT / 변경일자
  "CHNG_BF_CN" VARCHAR(500), -- CHNG_BF_CN / 변경전내용
...
CREATE TABLE IF NOT EXISTS "I1590" (
  "LCNS_NO" VARCHAR(500), -- LCNS_NO / 인허가번호 / PK 후보(HIGH) / FK 후보: I1200.LCNS_NO(HIGH, 0.2%)
  "BSSH_NM" VARCHAR(500), -- BSSH_NM / 업소명
...
CREATE TABLE IF NOT EXISTS "I0300" (
  ...
  "PRDLST_REPORT_NO" VARCHAR(500), -- PRDLST_REPORT_NO / 품목제조보고번호 / PK 후보(HIGH) / FK 후보: I1250.PRDLST_REPORT_NO(HIGH, 0.0%), C002.null(MEDIUM, 0.4%)
  ...
  FOREIGN KEY ("LCNS_NO", "PRDLST_REPORT_NO") REFERENCES "C002" ("LCNS_NO", "PRDLST_REPORT_NO")
);
...
CREATE TABLE IF NOT EXISTS "I2781" (
  ...
  "ACCEPT_NO" VARCHAR(500), -- ACCEPT_NO / 축산물수입신고필증번호 / PK 후보(HIGH)
  "HIST_NO" VARCHAR(500), -- HIST_NO / 수입신고확인증번호
  "ORGNP_NM" VARCHAR(500), -- ORGNP_NM / 원산지
  "BSSH_NM" VARCHAR(500), -- BSSH_NM / 수입업체명
  "APLC_DTM" VARCHAR(500), -- APLC_DTM / 신고일
...
CREATE TABLE IF NOT EXISTS "I0630" (
  ...
  "APPN_DT" VARCHAR(500), -- APPN_DT / 지정일자
  "BSSH_NM" VARCHAR(500), -- BSSH_NM / 업소명
  "LCNS_NO" VARCHAR(500), -- LCNS_NO / 업고고유번호 / FK 후보: I2500.LCNS_NO(HIGH, 0.0%)
...
CREATE TABLE IF NOT EXISTS "I-0050" (
  "HF_FNCLTY_MTRAL_RCOGN_NO" VARCHAR(500), -- HF_FNCLTY_MTRAL_RCOGN_NO / 원료인정번호 / PK 후보(HIGH) / FK 후보: I-0040.HF_FNCLTY_MTRAL_RCOGN_NO(HIGH, 0.2%)
  ...
  PRIMARY KEY ("HF_FNCLTY_MTRAL_RCOGN_NO"),
  FOREIGN KEY ("HF_FNCLTY_MTRAL_RCOGN_NO") REFERENCES "I-0040" ("HF_FNCLTY_MTRAL_RCOGN_NO")
);
...
CREATE TABLE IF NOT EXISTS "C006" (
  "BSSH_NM" VARCHAR(500), -- BSSH_NM / 업소명
  "PRDLST_REPORT_NO" VARCHAR(500), -- PRDLST_REPORT_NO / 품목제조번호 / PK 후보(HIGH) / FK 후보: I1310.PRDLST_REPORT_NO(HIGH, 0.0%), I1250.PRDLST_REPORT_NO(HIGH, 0.0%)
...
CREATE TABLE IF NOT EXISTS "I1370" (
  "LCNS_NO" VARCHAR(500), -- LCNS_NO / 인허가 번호 / PK 후보(HIGH) / FK 후보: I2500.LCNS_NO(HIGH, 0.0%)
  "BSSH_NM" VARCHAR(500), -- BSSH_NM / 업소명
  "PRSDNT_NM" VARCHAR(500), -- PRSDNT_NM / 대표자명
  "INDUTY_NM" VARCHAR(500), -- INDUTY_NM / 업종
...
CREATE TABLE IF NOT EXISTS "I1420" (
  ...
  "H_ITEM_NM" VARCHAR(500), -- H_ITEM_NM / 품목유형
  "LCNS_NO" VARCHAR(500), -- LCNS_NO / 인허가번호 / FK 후보: I1300.LCNS_NO(HIGH, 0.0%)
  "EVL_YR" VARCHAR(500), -- EVL_YR / 보고년도
  "PRDLST_REPORT_NO" VARCHAR(500), -- PRDLST_REPORT_NO / 품목제조보고번호 / PK 후보(HIGH) / FK 후보: I1310.PRDLST_REPORT_NO(HIGH, 0.0%), I1250.PRDLST_REPORT_NO(HIGH, 0.0%)
...
CREATE TABLE IF NOT EXISTS "I2832" (
  "LCNS_NO" VARCHAR(500), -- LCNS_NO / 인허가번호 / PK 후보(HIGH) / FK 후보: I2500.LCNS_NO(HIGH, 0.6%)
  "BSSH_NM" VARCHAR(500), -- BSSH_NM / 업소명
  "PRSDNT_NM" VARCHAR(500), -- PRSDNT_NM / 대표자명
  "INDUTY_NM" VARCHAR(500), -- INDUTY_NM / 업종
  "PRMS_DT" VARCHAR(500), -- PRMS_DT / 허가일자
...
CREATE TABLE IF NOT EXISTS "I2852" (
  "PRDLST_REPORT_NO" VARCHAR(500), -- PRDLST_REPORT_NO / 품목제조보고번호 / PK 후보(HIGH) / FK 후보: I2711.PRDLST_REPORT_NO(HIGH, 0.0%), I1310.PRDLST_REPORT_NO(HIGH, 0.0%)
  ...
  "LCNS_NO" VARCHAR(500), -- LCNS_NO / 인허가번호 / FK 후보: I2713.LCNS_NO(HIGH, 0.0%), I1300.LCNS_NO(HIGH, 2.8%)
  "BSSH_NM" VARCHAR(500), -- BSSH_NM / 업소명
...
CREATE TABLE IF NOT EXISTS "I0610" (
  "LCNS_NO" VARCHAR(500), -- LCNS_NO / 인허가번호 / PK 후보(HIGH) / FK 후보: I2500.LCNS_NO(HIGH, 0.0%), I1300.LCNS_NO(HIGH, 9.6%)
  "BSSH_NM" VARCHAR(500), -- BSSH_NM / 업소명
  "INDUTY_CD_NM" VARCHAR(500), -- INDUTY_CD_NM / 업종명
  "PRSDNT_NM" VARCHAR(500), -- PRSDNT_NM / 대표자명
  "CLSBIZ_DVS_CD_NM" VARCHAR(500), -- CLSBIZ_DVS_CD_NM / 영업상태
...
CREATE TABLE IF NOT EXISTS "I0080" (
  ...
  "BSSH_NM" VARCHAR(500), -- BSSH_NM / 업소명
  "LCNS_NO" VARCHAR(500), -- LCNS_NO / 인허가번호 / FK 후보: I2500.LCNS_NO(HIGH, 0.5%), I2713.LCNS_NO(HIGH, 0.0%), I1310.null(MEDIUM, 0.7%), C002.null(MEDIUM, 0.4%)
  "PRDLST_CD_NM" VARCHAR(500), -- PRDLST_CD_NM / 식품유형
  "PRDLST_NM" VARCHAR(500), -- PRDLST_NM / 제품명
  ...
  "PRDLST_REPORT_NO" VARCHAR(500), -- PRDLST_REPORT_NO / 품목보고번호 / FK 후보: I2711.PRDLST_REPORT_NO(HIGH, 0.0%), I1310.PRDLST_REPORT_NO(HIGH, 0.7%), I1310.null(MEDIUM, 0.7%), C002.null(MEDIUM, 0.4%)
  PRIMARY KEY ("CHILD_FFQ_CRTFC_NO"),
  FOREIGN KEY ("LCNS_NO") REFERENCES "I2500" ("LCNS_NO"),
  FOREIGN KEY ("LCNS_NO") REFERENCES "I2713" ("LCNS_NO"),
  FOREIGN KEY ("PRDLST_REPORT_NO") REFERENCES "I2711" ("PRDLST_REPORT_NO"),
  FOREIGN KEY ("PRDLST_REPORT_NO") REFERENCES "I1310" ("PRDLST_REPORT_NO"),
  FOREIGN KEY ("LCNS_NO", "PRDLST_REPORT_NO") REFERENCES "I1310" ("LCNS_NO", "PRDLST_REPORT_NO"),
  FOREIGN KEY ("LCNS_NO", "PRDLST_REPORT_NO") REFERENCES "C002" ("LCNS_NO", "PRDLST_REPORT_NO")
);
...
CREATE TABLE IF NOT EXISTS "I0320" (
  ...
  "PRDLST_REPORT_NO" VARCHAR(500), -- PRDLST_REPORT_NO / 품목보고번호 / PK 후보(HIGH) / FK 후보: I2711.PRDLST_REPORT_NO(HIGH, 0.0%), I1310.PRDLST_REPORT_NO(HIGH, 0.0%)
...
CREATE TABLE IF NOT EXISTS "I1790" (
  "HIST_TRACE_REG_NO" VARCHAR(500), -- HIST_TRACE_REG_NO / 이력추적등록번호 / PK 후보(HIGH) / FK 후보: I1800.HIST_TRACE_REG_NO(HIGH, 0.8%)
  ...
  PRIMARY KEY ("HIST_TRACE_REG_NO"),
  FOREIGN KEY ("HIST_TRACE_REG_NO") REFERENCES "I1800" ("HIST_TRACE_REG_NO")
);
...
CREATE TABLE IF NOT EXISTS "I0460" (
  ...
  "PRDLST_REPORT_NO" VARCHAR(500), -- PRDLST_REPORT_NO / 품목제조보고번호 / PK 후보(HIGH) / FK 후보: I2711.PRDLST_REPORT_NO(HIGH, 0.0%), I1310.PRDLST_REPORT_NO(HIGH, 2.6%)
  "LAST_UPDT_DTM" VARCHAR(500), -- LAST_UPDT_DTM / 최종수정일시
...
CREATE TABLE IF NOT EXISTS "I2854" (
  ...
  "PRDLST_CD" VARCHAR(500), -- PRDLST_CD / 식품유형 / PK 후보(MEDIUM)
...
CREATE TABLE IF NOT EXISTS "I2640" (
  ...
  "INSTT_NM" VARCHAR(500), -- INSTT_NM / 검사기관
  "REGSTR_TELNO" VARCHAR(500), -- REGSTR_TELNO / 전화번호
  "BRCDNO" VARCHAR(500), -- BRCDNO / 바코드번호 / PK 후보(HIGH) / FK 후보: I2620.BRCDNO(HIGH, 100.0%), I0490.BRCDNO(HIGH, 40.0%)
  "FRMLCUNIT" VARCHAR(500), -- FRMLCUNIT / 포장단위
  "TEST_ITMNM" VARCHAR(500), -- TEST_ITMNM / 부적합항목
  "STDR_STND" VARCHAR(500), -- STDR_STND / 기준규격
  "TESTANALS_RSLT" VARCHAR(500), -- TESTANALS_RSLT / 검사결과
...
CREATE TABLE IF NOT EXISTS "I0910" (
  "PRSEC_INSTT_RCOGN_NO" VARCHAR(500), -- PRSEC_INSTT_RCOGN_NO / 인정번호 / PK 후보(HIGH) / FK 후보: I0890.PRSEC_INSTT_RCOGN_NO(HIGH, 12.0%)
  "BSSH_NM" VARCHAR(500), -- BSSH_NM / 기관명
  "PRSDNT_NM" VARCHAR(500), -- PRSDNT_NM / 대표자
  "APPN_BGN_DT" VARCHAR(500), -- APPN_BGN_DT / 지정일자
...
CREATE TABLE IF NOT EXISTS "I2400" (
  ...
  "SPOT_NO" VARCHAR(500), -- SPOT_NO / 지점 번호 / PK 후보(HIGH)
  "SIGNGU_NM" VARCHAR(500), -- SIGNGU_NM / 시군구
  "ADDR" VARCHAR(500), -- ADDR / 주소
...
CREATE TABLE IF NOT EXISTS "I2560" (
  "LCNS_NO" VARCHAR(500), -- LCNS_NO / 인허가번호 / PK 후보(HIGH) / FK 후보: I2500.LCNS_NO(HIGH, 99.9%), I2713.LCNS_NO(HIGH, 0.0%)
  "BSSH_NM" VARCHAR(500), -- BSSH_NM / 업소명
...
CREATE TABLE IF NOT EXISTS "C005" (
  "PRDLST_REPORT_NO" VARCHAR(500), -- PRDLST_REPORT_NO / 품목보고(신고)번호 / PK 후보(HIGH) / FK 후보: I2711.PRDLST_REPORT_NO(HIGH, 0.0%), I1310.PRDLST_REPORT_NO(HIGH, 0.1%)
...
CREATE TABLE IF NOT EXISTS "I2610" (
  ...
  "SPEC_NM" VARCHAR(500), -- SPEC_NM / 기준규격명
  "PRDLST_CD" VARCHAR(500), -- PRDLST_CD / 품목코드 / PK 후보(LOW) / FK 후보: I2510.PRDLST_CD(HIGH, 12.5%)
  "KOR_NM" VARCHAR(500), -- KOR_NM / 한글명
...
CREATE TABLE IF NOT EXISTS "I1670" (
  "DSPS_STDR_CD" VARCHAR(500), -- DSPS_STDR_CD / 처분기준코드 / PK 후보(HIGH) / FK 후보: I2550.DSPS_STDR_CD(HIGH, 13.4%), I2550.null(MEDIUM, 13.4%)
  "DSPS_STDR_CD_NM" VARCHAR(500), -- DSPS_STDR_CD_NM / 처분기준명
  "LV_NO" VARCHAR(500), -- LV_NO / 레벨 / FK 후보: I2550.null(MEDIUM, 13.4%)
  "BASIS_LAWORD" VARCHAR(500), -- BASIS_LAWORD / 근거법령
  "VILT_TYPE_NM" VARCHAR(500), -- VILT_TYPE_NM / 위반유형
  "VALD_BGN_DT" VARCHAR(500), -- VALD_BGN_DT / 유효시작일자
  "VALD_END_DT" VARCHAR(500), -- VALD_END_DT / 유효종료일자
  ...
  FOREIGN KEY ("DSPS_STDR_CD", "LV_NO") REFERENCES "I2550" ("DSPS_STDR_CD", "LV_NO")
);
...
CREATE TABLE IF NOT EXISTS "I2550" (
  ...
  "HRNK_DSPS_STDR_CD" VARCHAR(500), -- HRNK_DSPS_STDR_CD / 상위처분기준코드 / FK 후보: I1670.DSPS_STDR_CD(HIGH, 7.0%)
...
CREATE TABLE IF NOT EXISTS "I0470" (
  ...
  FOREIGN KEY ("LCNS_NO") REFERENCES "I2500" ("LCNS_NO"),
  FOREIGN KEY ("LCNS_NO") REFERENCES "I2713" ("LCNS_NO"),
  FOREIGN KEY ("LCNS_NO", "DSPSDTLS_SEQ") REFERENCES "I0481" ("LCNS_NO", "DSPSDTLS_SEQ"),
  FOREIGN KEY ("LCNS_NO", "DSPSDTLS_SEQ") REFERENCES "I0480" ("LCNS_NO", "DSPSDTLS_SEQ"),
  FOREIGN KEY ("LCNS_NO", "DSPSDTLS_SEQ") REFERENCES "I0482" ("LCNS_NO", "DSPSDTLS_SEQ")
);
...
CREATE TABLE IF NOT EXISTS "I0482" (
  "PRCSCITYPOINT_BSSHNM" VARCHAR(500), -- PRCSCITYPOINT_BSSHNM / 업소명
  "INDUTY_CD_NM" VARCHAR(500), -- INDUTY_CD_NM / 업종
  "LCNS_NO" VARCHAR(500), -- LCNS_NO / 인허가번호 / PK 후보(HIGH) / FK 후보: I2500.LCNS_NO(HIGH, 0.0%), I1260.LCNS_NO(HIGH, 0.0%), I0470.null(MEDIUM, 11.1%)
  "DSPS_DCSNDT" VARCHAR(500), -- DSPS_DCSNDT / 처분확정일자
  "DSPS_BGNDT" VARCHAR(500), -- DSPS_BGNDT / 처분시작일(영업정지의경우)
  "DSPS_ENDDT" VARCHAR(500), -- DSPS_ENDDT / 처분종료일(영업정지의경우)
  "DSPS_TYPECD_NM" VARCHAR(500), -- DSPS_TYPECD_NM / 처분유형
  ...
  "PUBLIC_DT" VARCHAR(500), -- PUBLIC_DT / 공개기한
  "LAST_UPDT_DTM" VARCHAR(500), -- LAST_UPDT_DTM / 최종수정일
  "DSPSDTLS_SEQ" VARCHAR(500), -- DSPSDTLS_SEQ / 행정처분전산키 / FK 후보: I0470.null(MEDIUM, 11.1%)
  "DSPS_INSTTCD_NM" VARCHAR(500), -- DSPS_INSTTCD_NM / 처분기관명
  PRIMARY KEY ("LCNS_NO"),
  FOREIGN KEY ("LCNS_NO") REFERENCES "I2500" ("LCNS_NO"),
  FOREIGN KEY ("LCNS_NO") REFERENCES "I1260" ("LCNS_NO"),
...
CREATE TABLE IF NOT EXISTS "I0481" (
  "PRCSCITYPOINT_BSSHNM" VARCHAR(500), -- PRCSCITYPOINT_BSSHNM / 업소명
  "INDUTY_CD_NM" VARCHAR(500), -- INDUTY_CD_NM / 업종
  "LCNS_NO" VARCHAR(500), -- LCNS_NO / 인허가번호 / PK 후보(HIGH) / FK 후보: I2500.LCNS_NO(HIGH, 0.0%), I2713.LCNS_NO(HIGH, 0.0%), I0470.null(MEDIUM, 12.2%)
  "DSPS_DCSNDT" VARCHAR(500), -- DSPS_DCSNDT / 처분확정일자
  "DSPS_BGNDT" VARCHAR(500), -- DSPS_BGNDT / 처분시작일(영업정지의경우)
  "DSPS_ENDDT" VARCHAR(500), -- DSPS_ENDDT / 처분종료일(영업정지의경우)
  "DSPS_TYPECD_NM" VARCHAR(500), -- DSPS_TYPECD_NM / 처분유형
  ...
  "PUBLIC_DT" VARCHAR(500), -- PUBLIC_DT / 공개기한
  "LAST_UPDT_DTM" VARCHAR(500), -- LAST_UPDT_DTM / 최종수정일
  "DSPSDTLS_SEQ" VARCHAR(500), -- DSPSDTLS_SEQ / 행정처분전산키 / FK 후보: I0470.null(MEDIUM, 12.2%)
  "DSPS_INSTTCD_NM" VARCHAR(500), -- DSPS_INSTTCD_NM / 처분기관명
  PRIMARY KEY ("LCNS_NO"),
  FOREIGN KEY ("LCNS_NO") REFERENCES "I2500" ("LCNS_NO"),
  FOREIGN KEY ("LCNS_NO") REFERENCES "I2713" ("LCNS_NO"),
...
CREATE TABLE IF NOT EXISTS "I0310" (
  ...
  "GUBUN" VARCHAR(500), -- GUBUN / 품목구분
  "H_ITEM_NM" VARCHAR(500), -- H_ITEM_NM / 품목유형
  "LCNS_NO" VARCHAR(500), -- LCNS_NO / 인허가번호 / FK 후보: C003.null(MEDIUM, 6.2%), I0030.null(MEDIUM, 0.5%)
  "EVL_YR" VARCHAR(500), -- EVL_YR / 보고년도
  "PRDLST_REPORT_NO" VARCHAR(500), -- PRDLST_REPORT_NO / 품목제조보고번호 / PK 후보(HIGH) / FK 후보: I0030.PRDLST_REPORT_NO(HIGH, 0.5%), I1250.PRDLST_REPORT_NO(HIGH, 0.0%), C003.null(MEDIUM, 6.2%), I0030.null(MEDIUM, 0.5%)
  "FYER_PRDCTN_ABRT_QY" VARCHAR(500), -- FYER_PRDCTN_ABRT_QY / 연간생산능력(KG)
  "PRDCTN_QY" VARCHAR(500), -- PRDCTN_QY / 생산량(KG)
  PRIMARY KEY ("PRDLST_REPORT_NO"),
  FOREIGN KEY ("PRDLST_REPORT_NO") REFERENCES "I0030" ("PRDLST_REPORT_NO"),
  FOREIGN KEY ("PRDLST_REPORT_NO") REFERENCES "I1250" ("PRDLST_REPORT_NO"),
  FOREIGN KEY ("LCNS_NO", "PRDLST_REPORT_NO") REFERENCES "C003" ("LCNS_NO", "PRDLST_REPORT_NO"),
  FOREIGN KEY ("LCNS_NO", "PRDLST_REPORT_NO") REFERENCES "I0030" ("LCNS_NO", "PRDLST_REPORT_NO")
);
...
CREATE TABLE IF NOT EXISTS "I2712" (
  "LCNS_NO" VARCHAR(500), -- LCNS_NO / 인허가번호 / FK 후보: I2713.LCNS_NO(HIGH, 71.4%), I2711.null(MEDIUM, 4.9%)
  "BSSH_NM" VARCHAR(500), -- BSSH_NM / 업소명
  "PRDLST_REPORT_NO" VARCHAR(500), -- PRDLST_REPORT_NO / 품목제조번호 / PK 후보(HIGH) / FK 후보: I2711.PRDLST_REPORT_NO(HIGH, 4.9%), I1250.PRDLST_REPORT_NO(HIGH, 0.0%), I2711.null(MEDIUM, 4.9%)
  "PRMS_DT" VARCHAR(500), -- PRMS_DT / 보고일자
  "PRDLST_NM" VARCHAR(500), -- PRDLST_NM / 품목명
  "PRDLST_DCNM" VARCHAR(500), -- PRDLST_DCNM / 유형
  "RAWMTRL_NM" VARCHAR(500), -- RAWMTRL_NM / 원재료
...
CREATE TABLE IF NOT EXISTS "I0030" (
  "LCNS_NO" VARCHAR(500), -- LCNS_NO / 인허가번호 / FK 후보: I0310.null(MEDIUM, 0.5%), C003.null(MEDIUM, 0.1%)
  "BSSH_NM" VARCHAR(500), -- BSSH_NM / 업소_명
  "PRDLST_REPORT_NO" VARCHAR(500), -- PRDLST_REPORT_NO / 품목제조번호 / PK 후보(HIGH) / FK 후보: I0310.null(MEDIUM, 0.5%), C003.null(MEDIUM, 0.1%)
...
CREATE TABLE IF NOT EXISTS "C003" (
  "LCNS_NO" VARCHAR(500), -- LCNS_NO / 인허가번호 / FK 후보: I0310.null(MEDIUM, 6.2%), I0030.null(MEDIUM, 0.1%)
  "BSSH_NM" VARCHAR(500), -- BSSH_NM / 업소명
  "PRDLST_REPORT_NO" VARCHAR(500), -- PRDLST_REPORT_NO / 품목제조번호 / PK 후보(HIGH) / FK 후보: I0030.PRDLST_REPORT_NO(HIGH, 0.1%), I1250.PRDLST_REPORT_NO(HIGH, 0.0%), I0310.null(MEDIUM, 6.2%), I0030.null(MEDIUM, 0.1%)
  "PRDLST_NM" VARCHAR(500), -- PRDLST_NM / 품목명
  "PRMS_DT" VARCHAR(500), -- PRMS_DT / 보고일자
  "POG_DAYCNT" VARCHAR(500), -- POG_DAYCNT / 소비기한
...
CREATE TABLE IF NOT EXISTS "I1250" (
  "LCNS_NO" VARCHAR(500), -- LCNS_NO / 인허가번호 / FK 후보: I2500.LCNS_NO(HIGH, 100.0%), C002.null(MEDIUM, 0.2%)
  "BSSH_NM" VARCHAR(500), -- BSSH_NM / 업소명
  "PRDLST_REPORT_NO" VARCHAR(500), -- PRDLST_REPORT_NO / 품목제조번호 / PK 후보(HIGH) / FK 후보: C002.null(MEDIUM, 0.2%)
  "PRMS_DT" VARCHAR(500), -- PRMS_DT / 허가일자
  "PRDLST_NM" VARCHAR(500), -- PRDLST_NM / 제품명
  "PRDLST_DCNM" VARCHAR(500), -- PRDLST_DCNM / 품목유형명
  "PRODUCTION" VARCHAR(500), -- PRODUCTION / 생산종료여부
...
CREATE TABLE IF NOT EXISTS "C002" (
  "LCNS_NO" VARCHAR(500), -- LCNS_NO / 인허가번호 / FK 후보: I2500.LCNS_NO(HIGH, 1.1%), I1220.LCNS_NO(HIGH, 6.4%), I1250.null(MEDIUM, 0.2%)
  "BSSH_NM" VARCHAR(500), -- BSSH_NM / 업소명
  "PRDLST_REPORT_NO" VARCHAR(500), -- PRDLST_REPORT_NO / 품목제조번호 / PK 후보(HIGH) / FK 후보: I2711.PRDLST_REPORT_NO(HIGH, 0.0%), I1310.PRDLST_REPORT_NO(HIGH, 0.0%), I1250.null(MEDIUM, 0.2%)
  "PRMS_DT" VARCHAR(500), -- PRMS_DT / 보고일자
  "PRDLST_NM" VARCHAR(500), -- PRDLST_NM / 품목명
  "PRDLST_DCNM" VARCHAR(500), -- PRDLST_DCNM / 품목유형명
  "RAWMTRL_NM" VARCHAR(500), -- RAWMTRL_NM / 원재료명
  ...
  FOREIGN KEY ("PRDLST_REPORT_NO") REFERENCES "I2711" ("PRDLST_REPORT_NO"),
  FOREIGN KEY ("PRDLST_REPORT_NO") REFERENCES "I1310" ("PRDLST_REPORT_NO"),
  FOREIGN KEY ("LCNS_NO", "PRDLST_REPORT_NO") REFERENCES "I1250" ("LCNS_NO", "PRDLST_REPORT_NO")
);
...
-- 값 포함률: 100.0% (26/26)
-- 사유: 대상 테이블 I2590의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 코드 계열 필드 / 값 포함률 100.0%
-- FOREIGN KEY ("CMMN_SPEC_CD") REFERENCES "I2590" ("CMMN_SPEC_CD")
...
-- FK 후보 [HIGH/100] "I2640"."BRCDNO" -> "I2620"."BRCDNO"
-- 값 포함률: 100.0% (15/15)
-- 사유: 대상 테이블 I2620의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 값 포함률 100.0%
-- FOREIGN KEY ("BRCDNO") REFERENCES "I2620" ("BRCDNO")

-- FK 후보 [HIGH/100] "I2640"."BRCDNO" -> "I0490"."BRCDNO"
-- 값 포함률: 40.0% (6/15)
-- 사유: 대상 테이블 I0490의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 값 포함률 40.0%
-- FOREIGN KEY ("BRCDNO") REFERENCES "I0490" ("BRCDNO")
...
-- FK 후보 [HIGH/100] "I2620"."BRCDNO" -> "I0490"."BRCDNO"
-- 값 포함률: 41.4% (24/58)
-- 사유: 대상 테이블 I0490의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 값 포함률 41.4%
-- FOREIGN KEY ("BRCDNO") REFERENCES "I0490" ("BRCDNO")
...
-- FK 후보 [HIGH/100] "I2630"."LCNS_NO" -> "I1200"."LCNS_NO"
-- 값 포함률: 0.0% (0/993)
-- 사유: 대상 테이블 I1200의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 데이터셋명 도메인 유사성 가산점 +20 / 업무 명칭 규칙: "행정처분결과(식품접객업)" → "식품접객업정보" 부모-자식 관계 확인 / 값 포함률 낮음 0.0% (업무 명칭 규칙으로 CONFIRMED 유지)
-- FOREIGN KEY ("LCNS_NO") REFERENCES "I1200" ("LCNS_NO")
...
-- 값 포함률: 0.0% (0/45)
-- 사유: 대상 테이블 I1260의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 데이터셋명 도메인 유사성 가산점 +20 / 업무 명칭 규칙: "행정처분결과(수입식품업)" → "식품등수입판매업정보" 부모-자식 관계 확인 / 값 포함률 낮음 0.0% (업무 명칭 규칙으로 CONFIRMED 유지)
-- FOREIGN KEY ("LCNS_NO") REFERENCES "I1260" ("LCNS_NO")
...
-- 값 포함률: 0.8% (2/260)
-- 사유: 대상 테이블 I1220의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 데이터셋명 도메인 유사성 가산점 +20 / 업무 명칭 규칙: "행정처분결과(식품제조가공업)" → "식품제조가공업정보" 부모-자식 관계 확인 / 값 포함률 0.8%
-- FOREIGN KEY ("LCNS_NO") REFERENCES "I1220" ("LCNS_NO")
...
-- 값 포함률: 2.6% (10/383)
-- 사유: 대상 테이블 I1310의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 업무 명칭 규칙: "수거검사 계획 및 실적 관련 현황" → "축산물 품목제조정보" 부모-자식 관계 확인 / 값 포함률 2.6%
-- FOREIGN KEY ("PRDLST_REPORT_NO") REFERENCES "I1310" ("PRDLST_REPORT_NO")
...
-- 값 포함률: 0.0% (0/457)
-- 사유: 대상 테이블 I2500의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 업무 명칭 규칙: "HACCP 적용업소 지정 현황" → "인허가 업소 정보" 부모-자식 관계 확인 / 값 포함률 낮음 0.0% (업무 명칭 규칙으로 CONFIRMED 유지)
-- FOREIGN KEY ("LCNS_NO") REFERENCES "I2500" ("LCNS_NO")
...
-- 값 포함률: 9.6% (93/973)
-- 사유: 대상 테이블 I1300의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 데이터셋명 도메인 유사성 가산점 +20 / 업무 명칭 규칙: "축산물HACCP 지정정보" → "축산물 가공업허가정보" 부모-자식 관계 확인 / 값 포함률 9.6%
-- FOREIGN KEY ("LCNS_NO") REFERENCES "I1300" ("LCNS_NO")
...
-- 값 포함률: 2.8% (5/180)
-- 사유: 대상 테이블 I1300의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 업무 명칭 규칙: "생산중단제품정보" → "축산물 가공업허가정보" 부모-자식 관계 확인 / 값 포함률 2.8%
-- FOREIGN KEY ("LCNS_NO") REFERENCES "I1300" ("LCNS_NO")
...
-- FK 후보 [SUGGESTED/100] "I2829"."LCNS_NO" -> "I1220"."LCNS_NO"
-- 값 포함률: 0.0% (0/1000)
-- 사유: 대상 테이블 I1220의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 데이터셋명 도메인 유사성 가산점 +20 / 값 포함률 낮음 0.0% — 추정 후보로 분류
-- FOREIGN KEY ("LCNS_NO") REFERENCES "I1220" ("LCNS_NO")
...
-- FK 후보 [SUGGESTED/100] "I2834"."LCNS_NO" -> "I1200"."LCNS_NO"
-- 값 포함률: 0.0% (0/1000)
-- 사유: 대상 테이블 I1200의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 데이터셋명 도메인 유사성 가산점 +20 / 값 포함률 낮음 0.0% — 추정 후보로 분류
-- FOREIGN KEY ("LCNS_NO") REFERENCES "I1200" ("LCNS_NO")

-- FK 후보 [SUGGESTED/100] "I2856"."LCNS_NO" -> "I1200"."LCNS_NO"
-- 값 포함률: 0.0% (0/1000)
-- 사유: 대상 테이블 I1200의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 데이터셋명 도메인 유사성 가산점 +20 / 값 포함률 낮음 0.0% — 추정 후보로 분류
-- FOREIGN KEY ("LCNS_NO") REFERENCES "I1200" ("LCNS_NO")
...
-- 값 포함률: 0.0% (0/1000)
-- 사유: 대상 테이블 I2713의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 데이터셋명 도메인 유사성 가산점 +20 / 업무 명칭 규칙: "위생용품수입업영업신고대장" → "위생용품영업정보" 부모-자식 관계 확인 / 값 포함률 낮음 0.0% (업무 명칭 규칙으로 CONFIRMED 유지)
-- FOREIGN KEY ("LCNS_NO") REFERENCES "I2713" ("LCNS_NO")

-- FK 후보 [HIGH/100] "I2714"."LCNS_NO" -> "I1260"."LCNS_NO"
-- 값 포함률: 0.0% (0/1000)
-- 사유: 대상 테이블 I1260의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 데이터셋명 도메인 유사성 가산점 +20 / 업무 명칭 규칙: "위생용품수입업영업신고대장" → "식품등수입판매업정보" 부모-자식 관계 확인 / 값 포함률 낮음 0.0% (업무 명칭 규칙으로 CONFIRMED 유지)
-- FOREIGN KEY ("LCNS_NO") REFERENCES "I1260" ("LCNS_NO")

-- FK 후보 [HIGH/100] "I2711"."LCNS_NO" -> "I2713"."LCNS_NO"
-- 값 포함률: 81.4% (35/43)
-- 사유: 대상 테이블 I2713의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 데이터셋명 도메인 유사성 가산점 +20 / 값 포함률 81.4%
-- FOREIGN KEY ("LCNS_NO") REFERENCES "I2713" ("LCNS_NO")
...
-- 값 포함률: 2.8% (21/755)
-- 사유: 대상 테이블 I2711의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 데이터셋명 도메인 유사성 가산점 +20 / 업무 명칭 규칙: "위생용품영업 생산실적보고" → "위생용품품목제조보고" 부모-자식 관계 확인 / 값 포함률 2.8%
-- FOREIGN KEY ("PRDLST_REPORT_NO") REFERENCES "I2711" ("PRDLST_REPORT_NO")
...
-- FK 후보 [HIGH/100] "I1330"."LCNS_NO" -> "I2500"."LCNS_NO"
-- 값 포함률: 0.0% (0/1000)
-- 사유: 대상 테이블 I2500의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 업무 명칭 규칙: "축산물 보관업영업허가대장" → "인허가 업소 정보" 부모-자식 관계 확인 / 값 포함률 낮음 0.0% (업무 명칭 규칙으로 CONFIRMED 유지)
-- FOREIGN KEY ("LCNS_NO") REFERENCES "I2500" ("LCNS_NO")

-- FK 후보 [SUGGESTED/100] "I1330"."LCNS_NO" -> "I1300"."LCNS_NO"
-- 값 포함률: 0.0% (0/1000)
-- 사유: 대상 테이블 I1300의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 데이터셋명 도메인 유사성 가산점 +20 / 값 포함률 낮음 0.0% — 추정 후보로 분류
-- FOREIGN KEY ("LCNS_NO") REFERENCES "I1300" ("LCNS_NO")

-- FK 후보 [HIGH/100] "I1420"."LCNS_NO" -> "I1300"."LCNS_NO"
-- 값 포함률: 0.0% (0/33)
-- 사유: 대상 테이블 I1300의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 데이터셋명 도메인 유사성 가산점 +20 / 업무 명칭 규칙: "축산물 생산실적정보" → "축산물 가공업허가정보" 부모-자식 관계 확인 / 값 포함률 낮음 0.0% (업무 명칭 규칙으로 CONFIRMED 유지)
-- FOREIGN KEY ("LCNS_NO") REFERENCES "I1300" ("LCNS_NO")

-- FK 후보 [HIGH/100] "I1420"."PRDLST_REPORT_NO" -> "I1310"."PRDLST_REPORT_NO"
-- 값 포함률: 0.0% (0/1000)
-- 사유: 대상 테이블 I1310의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 데이터셋명 도메인 유사성 가산점 +20 / 업무 명칭 규칙: "축산물 생산실적정보" → "축산물 품목제조정보" 부모-자식 관계 확인 / 값 포함률 낮음 0.0% (업무 명칭 규칙으로 CONFIRMED 유지)
-- FOREIGN KEY ("PRDLST_REPORT_NO") REFERENCES "I1310" ("PRDLST_REPORT_NO")
...
-- FK 후보 [HIGH/100] "I1320"."LCNS_NO" -> "I2500"."LCNS_NO"
-- 값 포함률: 0.0% (0/1000)
-- 사유: 대상 테이블 I2500의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 업무 명칭 규칙: "축산물 식육포장처리업영업허가대장" → "인허가 업소 정보" 부모-자식 관계 확인 / 값 포함률 낮음 0.0% (업무 명칭 규칙으로 CONFIRMED 유지)
-- FOREIGN KEY ("LCNS_NO") REFERENCES "I2500" ("LCNS_NO")

-- FK 후보 [SUGGESTED/100] "I1320"."LCNS_NO" -> "I1300"."LCNS_NO"
-- 값 포함률: 0.0% (0/1000)
-- 사유: 대상 테이블 I1300의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 데이터셋명 도메인 유사성 가산점 +20 / 값 포함률 낮음 0.0% — 추정 후보로 분류
-- FOREIGN KEY ("LCNS_NO") REFERENCES "I1300" ("LCNS_NO")

-- FK 후보 [SUGGESTED/100] "I1340"."LCNS_NO" -> "I1300"."LCNS_NO"
-- 값 포함률: 0.0% (0/1000)
-- 사유: 대상 테이블 I1300의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 데이터셋명 도메인 유사성 가산점 +20 / 값 포함률 낮음 0.0% — 추정 후보로 분류
-- FOREIGN KEY ("LCNS_NO") REFERENCES "I1300" ("LCNS_NO")

-- FK 후보 [HIGH/100] "I1370"."LCNS_NO" -> "I2500"."LCNS_NO"
-- 값 포함률: 0.0% (0/54)
-- 사유: 대상 테이블 I2500의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 업무 명칭 규칙: "축산물 집유업영업허가대장" → "인허가 업소 정보" 부모-자식 관계 확인 / 값 포함률 낮음 0.0% (업무 명칭 규칙으로 CONFIRMED 유지)
-- FOREIGN KEY ("LCNS_NO") REFERENCES "I2500" ("LCNS_NO")

-- FK 후보 [SUGGESTED/100] "I1370"."LCNS_NO" -> "I1300"."LCNS_NO"
-- 값 포함률: 0.0% (0/54)
-- 사유: 대상 테이블 I1300의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 데이터셋명 도메인 유사성 가산점 +20 / 값 포함률 낮음 0.0% — 추정 후보로 분류
-- FOREIGN KEY ("LCNS_NO") REFERENCES "I1300" ("LCNS_NO")

-- FK 후보 [SUGGESTED/100] "I1350"."LCNS_NO" -> "I1300"."LCNS_NO"
-- 값 포함률: 0.0% (0/1000)
-- 사유: 대상 테이블 I1300의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 데이터셋명 도메인 유사성 가산점 +20 / 값 포함률 낮음 0.0% — 추정 후보로 분류
-- FOREIGN KEY ("LCNS_NO") REFERENCES "I1300" ("LCNS_NO")
...
-- 값 포함률: 100.0% (10/10)
-- 사유: 대상 테이블 I1300의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 데이터셋명 도메인 유사성 가산점 +20 / 값 포함률 100.0%
-- FOREIGN KEY ("LCNS_NO") REFERENCES "I1300" ("LCNS_NO")

-- FK 후보 [HIGH/100] "C006"."PRDLST_REPORT_NO" -> "I1310"."PRDLST_REPORT_NO"
-- 값 포함률: 0.0% (0/1000)
-- 사유: 대상 테이블 I1310의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 데이터셋명 도메인 유사성 가산점 +30 / 업무 명칭 규칙: "축산물품목제조보고(원재료)" → "축산물 품목제조정보" 부모-자식 관계 확인 / 값 포함률 낮음 0.0% (업무 명칭 규칙으로 CONFIRMED 유지)
-- FOREIGN KEY ("PRDLST_REPORT_NO") REFERENCES "I1310" ("PRDLST_REPORT_NO")

-- FK 후보 [HIGH/100] "C006"."PRDLST_REPORT_NO" -> "I1250"."PRDLST_REPORT_NO"
-- 값 포함률: 0.0% (0/1000)
-- 사유: 대상 테이블 I1250의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 데이터셋명 도메인 유사성 가산점 +10 / 업무 명칭 규칙: "축산물품목제조보고(원재료)" → "식품(첨가물)품목제조보고" 부모-자식 관계 확인 / 값 포함률 낮음 0.0% (업무 명칭 규칙으로 CONFIRMED 유지)
-- FOREIGN KEY ("PRDLST_REPORT_NO") REFERENCES "I1250" ("PRDLST_REPORT_NO")

-- FK 후보 [HIGH/100] "C006"."LCNS_NO" -> "I1300"."LCNS_NO"
-- 값 포함률: 9.6% (11/115)
-- 사유: 대상 테이블 I1300의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 데이터셋명 도메인 유사성 가산점 +20 / 값 포함률 9.6%
-- FOREIGN KEY ("LCNS_NO") REFERENCES "I1300" ("LCNS_NO")

-- FK 후보 [HIGH/100] "I-0050"."HF_FNCLTY_MTRAL_RCOGN_NO" -> "I-0040"."HF_FNCLTY_MTRAL_RCOGN_NO"
-- 값 포함률: 0.2% (1/430)
-- 사유: 대상 테이블 I-0040의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 데이터셋명 도메인 유사성 가산점 +20 / 값 포함률 0.2%
-- FOREIGN KEY ("HF_FNCLTY_MTRAL_RCOGN_NO") REFERENCES "I-0040" ("HF_FNCLTY_MTRAL_RCOGN_NO")

-- FK 후보 [HIGH/100] "I0310"."PRDLST_REPORT_NO" -> "I0030"."PRDLST_REPORT_NO"
-- 값 포함률: 0.5% (5/1000)
-- 사유: 대상 테이블 I0030의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 데이터셋명 도메인 유사성 가산점 +20 / 값 포함률 0.5%
-- FOREIGN KEY ("PRDLST_REPORT_NO") REFERENCES "I0030" ("PRDLST_REPORT_NO")
...
-- 값 포함률: 71.4% (115/161)
-- 사유: 대상 테이블 I2713의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 데이터셋명 도메인 유사성 가산점 +20 / 값 포함률 71.4%
-- FOREIGN KEY ("LCNS_NO") REFERENCES "I2713" ("LCNS_NO")

-- FK 후보 [HIGH/100] "I2712"."PRDLST_REPORT_NO" -> "I2711"."PRDLST_REPORT_NO"
-- 값 포함률: 4.9% (49/1000)
-- 사유: 대상 테이블 I2711의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 데이터셋명 도메인 유사성 가산점 +30 / 업무 명칭 규칙: "위생용품품목제조보고(원재료)" → "위생용품품목제조보고" 부모-자식 관계 확인 / 값 포함률 4.9%
-- FOREIGN KEY ("PRDLST_REPORT_NO") REFERENCES "I2711" ("PRDLST_REPORT_NO")

-- FK 후보 [HIGH/100] "I2712"."PRDLST_REPORT_NO" -> "I1250"."PRDLST_REPORT_NO"
-- 값 포함률: 0.0% (0/1000)
-- 사유: 대상 테이블 I1250의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 데이터셋명 도메인 유사성 가산점 +10 / 업무 명칭 규칙: "위생용품품목제조보고(원재료)" → "식품(첨가물)품목제조보고" 부모-자식 관계 확인 / 값 포함률 낮음 0.0% (업무 명칭 규칙으로 CONFIRMED 유지)
-- FOREIGN KEY ("PRDLST_REPORT_NO") REFERENCES "I1250" ("PRDLST_REPORT_NO")
...
-- 값 포함률: 0.1% (1/1000)
-- 사유: 대상 테이블 I0030의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 데이터셋명 도메인 유사성 가산점 +30 / 업무 명칭 규칙: "건강기능식품 품목제조신고(원재료)" → "건강기능식품 품목제조 신고사항 현황" 부모-자식 관계 확인 / 값 포함률 낮음 0.1% (업무 명칭 규칙으로 CONFIRMED 유지)
-- FOREIGN KEY ("PRDLST_REPORT_NO") REFERENCES "I0030" ("PRDLST_REPORT_NO")

-- FK 후보 [HIGH/100] "C003"."PRDLST_REPORT_NO" -> "I1250"."PRDLST_REPORT_NO"
-- 값 포함률: 0.0% (0/1000)
-- 사유: 대상 테이블 I1250의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 데이터셋명 도메인 유사성 가산점 +10 / 업무 명칭 규칙: "건강기능식품 품목제조신고(원재료)" → "식품(첨가물)품목제조보고" 부모-자식 관계 확인 / 값 포함률 낮음 0.0% (업무 명칭 규칙으로 CONFIRMED 유지)
-- FOREIGN KEY ("PRDLST_REPORT_NO") REFERENCES "I1250" ("PRDLST_REPORT_NO")

-- FK 후보 [HIGH/100] "C001"."LCNS_NO" -> "I1260"."LCNS_NO"
-- 값 포함률: 100.0% (1000/1000)
-- 사유: 대상 테이블 I1260의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 데이터셋명 도메인 유사성 가산점 +20 / 업무 명칭 규칙: "수입식품등영업신고대장" → "식품등수입판매업정보" 부모-자식 관계 확인 / 값 포함률 100.0%
-- FOREIGN KEY ("LCNS_NO") REFERENCES "I1260" ("LCNS_NO")

-- FK 후보 [HIGH/100] "I0250"."LCNS_NO" -> "I1260"."LCNS_NO"
-- 값 포함률: 2.5% (1/40)
-- 사유: 대상 테이블 I1260의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 데이터셋명 도메인 유사성 가산점 +20 / 업무 명칭 규칙: "우수수입업소 등록 현황" → "식품등수입판매업정보" 부모-자식 관계 확인 / 값 포함률 2.5%
-- FOREIGN KEY ("LCNS_NO") REFERENCES "I1260" ("LCNS_NO")

-- FK 후보 [SUGGESTED/100] "I2847"."LCNS_NO" -> "I1200"."LCNS_NO"
-- 값 포함률: 0.0% (0/989)
-- 사유: 대상 테이블 I1200의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 데이터셋명 도메인 유사성 가산점 +20 / 값 포함률 낮음 0.0% — 추정 후보로 분류
-- FOREIGN KEY ("LCNS_NO") REFERENCES "I1200" ("LCNS_NO")
...
-- 값 포함률: 6.4% (17/265)
-- 사유: 대상 테이블 I1220의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 값 포함률 6.4%
-- FOREIGN KEY ("LCNS_NO") REFERENCES "I1220" ("LCNS_NO")

-- FK 후보 [HIGH/100] "C002"."PRDLST_REPORT_NO" -> "I2711"."PRDLST_REPORT_NO"
-- 값 포함률: 0.0% (0/1000)
-- 사유: 대상 테이블 I2711의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 데이터셋명 도메인 유사성 가산점 +10 / 업무 명칭 규칙: "식품(첨가물)품목제조보고(원재료)" → "위생용품품목제조보고" 부모-자식 관계 확인 / 값 포함률 낮음 0.0% (업무 명칭 규칙으로 CONFIRMED 유지)
-- FOREIGN KEY ("PRDLST_REPORT_NO") REFERENCES "I2711" ("PRDLST_REPORT_NO")

-- FK 후보 [HIGH/100] "C002"."PRDLST_REPORT_NO" -> "I1310"."PRDLST_REPORT_NO"
-- 값 포함률: 0.0% (0/1000)
-- 사유: 대상 테이블 I1310의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 데이터셋명 도메인 유사성 가산점 +10 / 업무 명칭 규칙: "식품(첨가물)품목제조보고(원재료)" → "축산물 품목제조정보" 부모-자식 관계 확인 / 값 포함률 낮음 0.0% (업무 명칭 규칙으로 CONFIRMED 유지)
-- FOREIGN KEY ("PRDLST_REPORT_NO") REFERENCES "I1310" ("PRDLST_REPORT_NO")
...
-- 값 포함률: 0.0% (0/988)
-- 사유: 대상 테이블 I1250의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 업무 명칭 규칙: "식품.식품첨가물 생산실적 보고 현황" → "식품(첨가물)품목제조보고" 부모-자식 관계 확인 / 값 포함률 낮음 0.0% (업무 명칭 규칙으로 CONFIRMED 유지)
-- FOREIGN KEY ("PRDLST_REPORT_NO") REFERENCES "I1250" ("PRDLST_REPORT_NO")

-- FK 후보 [HIGH/100] "I1590"."LCNS_NO" -> "I1200"."LCNS_NO"
-- 값 포함률: 0.2% (2/806)
-- 사유: 대상 테이블 I1200의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 데이터셋명 도메인 유사성 가산점 +20 / 값 포함률 0.2%
-- FOREIGN KEY ("LCNS_NO") REFERENCES "I1200" ("LCNS_NO")
...
-- FK 후보 [SUGGESTED/100] "I1230"."LCNS_NO" -> "I1220"."LCNS_NO"
-- 값 포함률: 0.0% (0/1000)
-- 사유: 대상 테이블 I1220의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 데이터셋명 도메인 유사성 가산점 +20 / 값 포함률 낮음 0.0% — 추정 후보로 분류
-- FOREIGN KEY ("LCNS_NO") REFERENCES "I1220" ("LCNS_NO")

-- FK 후보 [HIGH/100] "C004"."LCNS_NO" -> "I1200"."LCNS_NO"
-- 값 포함률: 0.3% (3/1000)
-- 사유: 대상 테이블 I1200의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 데이터셋명 도메인 유사성 가산점 +20 / 업무 명칭 규칙: "식품접객업소 위생등급 지정현황" → "식품접객업정보" 부모-자식 관계 확인 / 값 포함률 0.3%
-- FOREIGN KEY ("LCNS_NO") REFERENCES "I1200" ("LCNS_NO")
...
-- 값 포함률: 100.0% (157/157)
-- 사유: 대상 테이블 I1200의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 데이터셋명 도메인 유사성 가산점 +20 / 업무 명칭 규칙: "음식점업소 인허가 변경 정보" → "식품접객업정보" 부모-자식 관계 확인 / 값 포함률 100.0%
-- FOREIGN KEY ("LCNS_NO") REFERENCES "I1200" ("LCNS_NO")

-- FK 후보 [SUGGESTED/100] "I0060"."LCNS_NO" -> "I1220"."LCNS_NO"
-- 값 포함률: 0.0% (0/1000)
-- 사유: 대상 테이블 I1220의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 데이터셋명 도메인 유사성 가산점 +20 / 값 포함률 낮음 0.0% — 추정 후보로 분류
-- FOREIGN KEY ("LCNS_NO") REFERENCES "I1220" ("LCNS_NO")
...
-- FK 후보 [HIGH/100] "I0680"."LCNS_NO" -> "I1260"."LCNS_NO"
-- 값 포함률: 0.0% (0/759)
-- 사유: 대상 테이블 I1260의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 업무 명칭 규칙: "위생관리등급별 업소 현황" → "식품등수입판매업정보" 부모-자식 관계 확인 / 값 포함률 낮음 0.0% (업무 명칭 규칙으로 CONFIRMED 유지)
-- FOREIGN KEY ("LCNS_NO") REFERENCES "I1260" ("LCNS_NO")
...
-- FK 후보 [HIGH/100] "I2821"."LCNS_NO" -> "I1260"."LCNS_NO"
-- 값 포함률: 0.0% (0/1000)
-- 사유: 대상 테이블 I1260의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 데이터셋명 도메인 유사성 가산점 +20 / 업무 명칭 규칙: "수입식품업 폐업정보" → "식품등수입판매업정보" 부모-자식 관계 확인 / 값 포함률 낮음 0.0% (업무 명칭 규칙으로 CONFIRMED 유지)
-- FOREIGN KEY ("LCNS_NO") REFERENCES "I1260" ("LCNS_NO")
...
-- 값 포함률: 0.0% (0/1000)
-- 사유: 대상 테이블 I1220의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 데이터셋명 도메인 유사성 가산점 +20 / 업무 명칭 규칙: "식품첨가물제조업 폐업정보" → "식품제조가공업정보" 부모-자식 관계 확인 / 값 포함률 낮음 0.0% (업무 명칭 규칙으로 CONFIRMED 유지)
-- FOREIGN KEY ("LCNS_NO") REFERENCES "I1220" ("LCNS_NO")
...
-- 값 포함률: 0.0% (0/1000)
-- 사유: 대상 테이블 I1220의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 데이터셋명 도메인 유사성 가산점 +20 / 업무 명칭 규칙: "식품제조가공업 폐업정보" → "식품제조가공업정보" 부모-자식 관계 확인 / 값 포함률 낮음 0.0% (업무 명칭 규칙으로 CONFIRMED 유지)
-- FOREIGN KEY ("LCNS_NO") REFERENCES "I1220" ("LCNS_NO")
...
-- 값 포함률: 0.0% (0/1000)
-- 사유: 대상 테이블 I2713의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 데이터셋명 도메인 유사성 가산점 +20 / 업무 명칭 규칙: "위생용품 폐업정보" → "위생용품영업정보" 부모-자식 관계 확인 / 값 포함률 낮음 0.0% (업무 명칭 규칙으로 CONFIRMED 유지)
-- FOREIGN KEY ("LCNS_NO") REFERENCES "I2713" ("LCNS_NO")
...
-- FK 후보 [HIGH/100] "I2820"."LCNS_NO" -> "I1200"."LCNS_NO"
-- 값 포함률: 0.0% (0/1000)
-- 사유: 대상 테이블 I1200의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 데이터셋명 도메인 유사성 가산점 +20 / 업무 명칭 규칙: "집단급식소 폐업정보" → "식품접객업정보" 부모-자식 관계 확인 / 값 포함률 낮음 0.0% (업무 명칭 규칙으로 CONFIRMED 유지)
-- FOREIGN KEY ("LCNS_NO") REFERENCES "I1200" ("LCNS_NO")
...
-- 값 포함률: 0.0% (0/1000)
-- 사유: 대상 테이블 I1300의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 데이터셋명 도메인 유사성 가산점 +20 / 업무 명칭 규칙: "축산물 가공업 폐업정보" → "축산물 가공업허가정보" 부모-자식 관계 확인 / 값 포함률 낮음 0.0% (업무 명칭 규칙으로 CONFIRMED 유지)
-- FOREIGN KEY ("LCNS_NO") REFERENCES "I1300" ("LCNS_NO")
...
-- FK 후보 [HIGH/100] "I2819"."LCNS_NO" -> "I1200"."LCNS_NO"
-- 값 포함률: 0.0% (0/1000)
-- 사유: 대상 테이블 I1200의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 데이터셋명 도메인 유사성 가산점 +20 / 업무 명칭 규칙: "식품접객업 폐업정보" → "식품접객업정보" 부모-자식 관계 확인 / 값 포함률 낮음 0.0% (업무 명칭 규칙으로 CONFIRMED 유지)
-- FOREIGN KEY ("LCNS_NO") REFERENCES "I1200" ("LCNS_NO")
...
-- 값 포함률: 0.0% (0/1000)
-- 사유: 대상 테이블 I1220의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 데이터셋명 도메인 유사성 가산점 +20 / 업무 명칭 규칙: "즉석판매제조가공업 폐업정보" → "식품제조가공업정보" 부모-자식 관계 확인 / 값 포함률 낮음 0.0% (업무 명칭 규칙으로 CONFIRMED 유지)
-- FOREIGN KEY ("LCNS_NO") REFERENCES "I1220" ("LCNS_NO")
...
-- 값 포함률: 0.0% (0/1000)
-- 사유: 대상 테이블 I1300의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 데이터셋명 도메인 유사성 가산점 +20 / 업무 명칭 규칙: "축산물 식육포장처리업 폐업정보" → "축산물 가공업허가정보" 부모-자식 관계 확인 / 값 포함률 낮음 0.0% (업무 명칭 규칙으로 CONFIRMED 유지)
-- FOREIGN KEY ("LCNS_NO") REFERENCES "I1300" ("LCNS_NO")
...
-- 값 포함률: 0.0% (0/1000)
-- 사유: 대상 테이블 I1300의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 데이터셋명 도메인 유사성 가산점 +20 / 업무 명칭 규칙: "축산물(도축업,보관업,운반업,집유업,식용란선별포장업) 폐업정보" → "축산물 가공업허가정보" 부모-자식 관계 확인 / 값 포함률 낮음 0.0% (업무 명칭 규칙으로 CONFIRMED 유지)
-- FOREIGN KEY ("LCNS_NO") REFERENCES "I1300" ("LCNS_NO")
...
-- 값 포함률: 0.0% (0/1000)
-- 사유: 대상 테이블 I1300의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 데이터셋명 도메인 유사성 가산점 +20 / 업무 명칭 규칙: "축산물 판매업 폐업정보" → "축산물 가공업허가정보" 부모-자식 관계 확인 / 값 포함률 낮음 0.0% (업무 명칭 규칙으로 CONFIRMED 유지)
-- FOREIGN KEY ("LCNS_NO") REFERENCES "I1300" ("LCNS_NO")
...
-- FK 후보 [SUGGESTED/93] "I0950"."PRDLST_CD" -> "I2510"."PRDLST_CD"
-- 값 포함률: 0.0% (0/579)
-- 사유: 대상 테이블 I2510의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 코드 계열 필드 / 대표 마스터 테이블 규칙 적용 / 값 포함률 낮음 0.0% — 추정 후보로 분류
-- FOREIGN KEY ("PRDLST_CD") REFERENCES "I2510" ("PRDLST_CD")
...
-- FK 후보 [HIGH/92] "I2550"."HRNK_DSPS_STDR_CD" -> "I1670"."DSPS_STDR_CD"
-- 값 포함률: 7.0% (12/172)
-- 사유: 필드명 유사 매칭 유사도 82% (정규화 기준, -3점) / 대상 테이블 I1670의 PK 후보(HIGH)와 동일 필드 / 코드 계열 필드 / 값 포함률 7.0%
-- FOREIGN KEY ("HRNK_DSPS_STDR_CD") REFERENCES "I1670" ("DSPS_STDR_CD")

-- FK 후보 [HIGH/85] "I0910"."PRSEC_INSTT_RCOGN_NO" -> "I0890"."PRSEC_INSTT_RCOGN_NO"
-- 값 포함률: 12.0% (20/166)
-- 사유: 대상 테이블 I0890의 PK 후보(HIGH)와 동일 필드 / 값 포함률 12.0%
-- FOREIGN KEY ("PRSEC_INSTT_RCOGN_NO") REFERENCES "I0890" ("PRSEC_INSTT_RCOGN_NO")

-- FK 후보 [HIGH/85] "I1790"."HIST_TRACE_REG_NO" -> "I1800"."HIST_TRACE_REG_NO"
-- 값 포함률: 0.8% (8/1000)
-- 사유: 대상 테이블 I1800의 PK 후보(HIGH)와 동일 필드 / 값 포함률 0.8%
-- FOREIGN KEY ("HIST_TRACE_REG_NO") REFERENCES "I1800" ("HIST_TRACE_REG_NO")
...
-- 값 포함률: 0.1% (1/806)
-- 사유: 대상 테이블 I2500의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 대표 마스터 테이블 규칙 적용 / 값 포함률 낮음 0.1% — 추정 후보로 분류
-- FOREIGN KEY ("LCNS_NO") REFERENCES "I2500" ("LCNS_NO")
...
-- FK 후보 [SUGGESTED/78] "I2610"."CMMN_SPEC_CD" -> "I2590"."CMMN_SPEC_CD"
-- 값 포함률: 0.0% (0/6)
-- 사유: 대상 테이블 I2590의 PK 후보(HIGH)와 동일 필드 / 공통 관계키 목록에 포함 / 코드 계열 필드 / 값 포함률 낮음 0.0% — 추정 후보로 분류
-- FOREIGN KEY ("CMMN_SPEC_CD") REFERENCES "I2590" ("CMMN_SPEC_CD")

-- FK 후보 [SUGGESTED/68] "I0990"."LIMIT_STDR_STND_RCOGN_NO" -> "I1010"."LIMIT_STDR_STND_RCOGN_NO"
-- 값 포함률: 0.0% (0/14)
-- 사유: 대상 테이블 I1010의 PK 후보(HIGH)와 동일 필드 / 데이터셋명 도메인 유사성 가산점 +20 / 값 포함률 낮음 0.0% — 추정 후보로 분류
-- FOREIGN KEY ("LIMIT_STDR_STND_RCOGN_NO") REFERENCES "I1010" ("LIMIT_STDR_STND_RCOGN_NO")
...
-- 제외 FK 후보 "I2510"."HRNK_PRDLST_CD" -> "I0960"."PRDLST_CD"
-- 값 포함률: 0.0% (0/338)
-- 제외 사유: 추정 후보 점수 57점으로 기준 미달

-- 제외 FK 후보 "I2510"."HRNK_PRDLST_CD" -> "I0940"."PRDLST_CD"
-- 값 포함률: 0.0% (0/338)
-- 제외 사유: 추정 후보 점수 49점으로 기준 미달

-- 제외 FK 후보 "I2510"."HRNK_PRDLST_CD" -> "I0950"."PRDLST_CD"
-- 값 포함률: 0.0% (0/338)
-- 제외 사유: 추정 후보 점수 57점으로 기준 미달

-- 제외 FK 후보 "I2510"."HRNK_PRDLST_CD" -> "I2854"."PRDLST_CD"
-- 값 포함률: 0.0% (0/338)
-- 제외 사유: 추정 후보 점수 53점으로 기준 미달

-- 제외 FK 후보 "I2510"."HTRK_PRDLST_CD" -> "I0960"."PRDLST_CD"
-- 값 포함률: 0.0% (0/1)
-- 제외 사유: 추정 후보 점수 57점으로 기준 미달

-- 제외 FK 후보 "I2510"."HTRK_PRDLST_CD" -> "I0940"."PRDLST_CD"
-- 값 포함률: 0.0% (0/1)
-- 제외 사유: 추정 후보 점수 49점으로 기준 미달

-- 제외 FK 후보 "I2510"."HTRK_PRDLST_CD" -> "I0950"."PRDLST_CD"
-- 값 포함률: 0.0% (0/1)
-- 제외 사유: 추정 후보 점수 57점으로 기준 미달

-- 제외 FK 후보 "I2510"."HTRK_PRDLST_CD" -> "I2854"."PRDLST_CD"
-- 값 포함률: 0.0% (0/1)
-- 제외 사유: 추정 후보 점수 53점으로 기준 미달

-- 제외 FK 후보 "I2380"."ZIPNO" -> "I1550"."ZIPNO"
-- 값 포함률: 0.0% (0/17)
-- 제외 사유: 추정 후보 점수 46점으로 기준 미달
...
-- 제외 FK 후보 "I2780"."ACCEPT_NO" -> "I2781"."ACCEPT_NO"
-- 값 포함률: 0.0% (0/55)
-- 제외 사유: 추정 후보 점수 50점으로 기준 미달
