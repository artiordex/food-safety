...
const WEAK_KEY_PATTERN = /^STEP$|^OPERTN_CITYPOINT$|^FRMLCUNIT$|^FRMLC_UNIT$|^SPEC_VAL_SUMUP$|^SPECVALSUMUP$|_SUMUP$|^SORC$|^SOURCE$|^DSPSCN$|^VILTCN$|^VILTDTLS$|_DTLS$|_NM$|NM$|_DCNM$|DCNM$|_NAME$|NAME$|_CD_NM$|ADDR$|ADDRESS$|DT$|_YMD$|DTM$|DATE$|_MM$|_YEAR$|_YR$|_CN$|_CONT$|_CONTENT$|_DESC$|_MEMO$|_PRVNS$|_MTHD$|TELNO$|TEL_NO$|_TELNO$|PHONE$|MOBILE$|FAX$|_QY$|_VAL$|LV_NO$|PRODUCTION$|_CNT$|_COUNT$|_AMT$|_AMOUNT$|_QTY$|_WGHT$|_RATE$|_RATIO$|_PCT$|_TOT$|_SUM$|_AVG$|_MAX$|_MIN$|YEAR$|AREA$|_FNCLTY$|_STND$|DISPOS$|USAGE$|_MTRQLT$|_DAYCNT$|_YN$|^BOD$|^COD$|^SS$|^DO$|^TN$|^TP$|^ORGNICPH$|^PCE$|^TCE$|^PHNL$|^BENZ$|^TOLUE$|^ETBEN$|^XYLEN$|^TPH$|^CR6$|^ZINC$|^NICKEL$|^IMCOW$|^CYN$|^PB$|^CDMM$|^COPPR$|^MRC$|^HYDRIONDNSTY$|^VALDMANLI$|^CHOICIMPROPT$|^CHOICFIT$|^DISTBTMLMT$|^UPTLMT$|^LWRLMT$|_LMT$|^LV$|^GRADE$|_RSLT$|^TESTANALSRSLT$|_NM_KOR$|_NM_ENG$/i;
