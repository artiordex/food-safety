...
-- ============================================================
-- [사례 61] 농약잔류허용기준 통합 조회
--   농약잔류허용기준 + 식품별 기준 (SCN_002)
-- ============================================================

-- 61-1. 농약잔류기준 × 식품별기준 통합  [FOOD_KOR_NM, AGCHM_KOR_NM 공통키]
SELECT DISTINCT
    a.AGCHM_KOR_NM             AS 농약명,
    a.FOOD_KOR_NM              AS 식품명,
    a.MRL_VAL                  AS MRL값,
...
FROM "I1040" a
JOIN "I1050" b 
  ON a.FOOD_KOR_NM = b.FOOD_KOR_NM 
  AND a.AGCHM_KOR_NM = b.AGCHM_KOR_NM
LIMIT 30;
...
-- 62-1. 식품접객업소 등 업종별 행정처분 통합 조회 (UNION ALL)
SELECT DISTINCT
    '식품제조가공업' AS 업종,
    PRCSCITYPOINT_BSSHNM AS 업소명,
    LCNS_NO AS 인허가번호,
    DSPSCN AS 처분내용,
    DSPS_BGNDT AS 처분시작일,
    DSPS_ENDDT AS 처분종료일
...
FROM "I2711" a
LEFT JOIN "I2712" b ON a.PRDLST_REPORT_NO = b.PRDLST_REPORT_NO
...
FROM "C002" a
LEFT JOIN "C005" b ON a.PRDLST_REPORT_NO = b.PRDLST_REPORT_NO
LEFT JOIN "I1250" c ON a.LCNS_NO = c.LCNS_NO
LEFT JOIN "I2852" d ON b.PRDLST_REPORT_NO = d.PRDLST_REPORT_NO
LIMIT 30;
...
FROM "C006" a
LEFT JOIN "I2852" b ON a.PRDLST_REPORT_NO = b.PRDLST_REPORT_NO
...
LEFT JOIN "C005" c ON a.PRDLST_REPORT_NO = c.PRDLST_REPORT_NO
LIMIT 30;
