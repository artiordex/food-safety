...
-- -----------------------------------------------------------------------------
-- 11. [HIGH] I0960.TESTITM_CD <-> I2530.TESTITM_CD
...
-- -----------------------------------------------------------------------------
-- 15. [HIGH] I0950.TESTITM_CD <-> I2530.TESTITM_CD
...
-- -----------------------------------------------------------------------------
-- 16. [HIGH] I2550.HRNK_DSPS_STDR_CD <-> I1670.DSPS_STDR_CD
...
-- -----------------------------------------------------------------------------
-- 17. [HIGH] C002.LCNS_NO <-> I1220.LCNS_NO
...
-- -----------------------------------------------------------------------------
-- 19. [HIGH] I2712.PRDLST_REPORT_NO <-> I2711.PRDLST_REPORT_NO
...
-- -----------------------------------------------------------------------------
-- 20. [HIGH] C006.LCNS_NO <-> I1300.LCNS_NO
...
-- -----------------------------------------------------------------------------
-- 21. [HIGH] I2852.LCNS_NO <-> I1220.LCNS_NO
...
-- -----------------------------------------------------------------------------
-- 22. [HIGH] I2610.TESTITM_CD <-> I2530.TESTITM_CD
...
-- -----------------------------------------------------------------------------
-- 23. [HIGH] I2852.LCNS_NO <-> I1300.LCNS_NO
...
-- -----------------------------------------------------------------------------
-- 24. [HIGH] I1230.LCNS_NO <-> I2500.LCNS_NO
...
-- -----------------------------------------------------------------------------
-- 25. [HIGH] I2832.LCNS_NO <-> I2500.LCNS_NO
...
-- -----------------------------------------------------------------------------
-- 26. [HIGH] I0310.PRDLST_REPORT_NO <-> I0030.PRDLST_REPORT_NO
...
-- -----------------------------------------------------------------------------
-- 27. [HIGH] C002.LCNS_NO <-> I2500.LCNS_NO
...
-- -----------------------------------------------------------------------------
-- 28. [HIGH] I2560.LCNS_NO <-> I1300.LCNS_NO
...
-- -----------------------------------------------------------------------------
-- 29. [HIGH] I2600.PRDLST_CD <-> I0950.PRDLST_CD
...
-- -----------------------------------------------------------------------------
-- 33. [HIGH] C003.PRDLST_REPORT_NO <-> I0030.PRDLST_REPORT_NO
...
-- -----------------------------------------------------------------------------
-- 34. [HIGH] I2811.LCNS_NO <-> I2500.LCNS_NO
--   - 값 일치율: 0.1% (1개 / Unique 1000개)
--   - 실제 JOIN 레코드 수: 1건
