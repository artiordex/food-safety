...
--   총 검증된 체인 조인: 227개
--   생성일시: 2026-06-19T07:08:28.718+09:00
-- =============================================================================

-- -----------------------------------------------------------------------------
-- 1. [4차 체인 JOIN] C003 <-> I0490 <-> I0960 <-> I2580
...
-- -----------------------------------------------------------------------------
-- 3. [4차 체인 JOIN] C003 <-> I-0020 <-> I2860 <-> I0310
...
-- -----------------------------------------------------------------------------
-- 4. [4차 체인 JOIN] C003 <-> I0310 <-> I-0020 <-> I2860
...
-- -----------------------------------------------------------------------------
-- 5. [4차 체인 JOIN] C003 <-> I0310 <-> I0630 <-> I2860
...
-- -----------------------------------------------------------------------------
-- 6. [4차 체인 JOIN] C003 <-> I0310 <-> I2860 <-> I-0020
...
-- -----------------------------------------------------------------------------
-- 7. [4차 체인 JOIN] C003 <-> I0310 <-> I2860 <-> I0630
...
-- -----------------------------------------------------------------------------
-- 8. [4차 체인 JOIN] C003 <-> I0630 <-> I0310 <-> I2860
...
-- -----------------------------------------------------------------------------
-- 9. [4차 체인 JOIN] C003 <-> I0630 <-> I2860 <-> I0310
...
-- -----------------------------------------------------------------------------
-- 10. [4차 체인 JOIN] C003 <-> I0030 <-> I0310 <-> I2860
...
-- -----------------------------------------------------------------------------
-- 11. [4차 체인 JOIN] C003 <-> I0030 <-> I2860 <-> I0310
...
-- -----------------------------------------------------------------------------
-- 12. [4차 체인 JOIN] C003 <-> I0310 <-> I0030 <-> I2860
...
-- -----------------------------------------------------------------------------
-- 13. [4차 체인 JOIN] C003 <-> I0310 <-> I2860 <-> I0030
...
-- -----------------------------------------------------------------------------
-- 14. [4차 체인 JOIN] C003 <-> I-0020 <-> I0030 <-> I2860
...
-- -----------------------------------------------------------------------------
-- 15. [4차 체인 JOIN] C003 <-> I-0020 <-> I2860 <-> I0030
...
-- -----------------------------------------------------------------------------
-- 16. [4차 체인 JOIN] C003 <-> I0030 <-> I-0020 <-> I2860
...
-- -----------------------------------------------------------------------------
-- 17. [4차 체인 JOIN] C003 <-> I0030 <-> I0630 <-> I2860
...
-- -----------------------------------------------------------------------------
-- 18. [4차 체인 JOIN] C003 <-> I0030 <-> I2860 <-> I-0020
...
-- -----------------------------------------------------------------------------
-- 19. [4차 체인 JOIN] C003 <-> I0030 <-> I2860 <-> I0630
...
-- -----------------------------------------------------------------------------
-- 20. [4차 체인 JOIN] C003 <-> I0630 <-> I0030 <-> I2860
...
-- -----------------------------------------------------------------------------
-- 21. [4차 체인 JOIN] C003 <-> I0630 <-> I2860 <-> I0030
...
-- -----------------------------------------------------------------------------
-- 22. [4차 체인 JOIN] C003 <-> I0490 <-> I0960 <-> I0940
...
-- -----------------------------------------------------------------------------
-- 23. [4차 체인 JOIN] C003 <-> I0490 <-> I0960 <-> I2600
...
-- -----------------------------------------------------------------------------
-- 25. [4차 체인 JOIN] C003 <-> I0490 <-> I0960 <-> I0950
...
-- -----------------------------------------------------------------------------
-- 52. [4차 체인 JOIN] C003 <-> I0030 <-> I0490 <-> I0960
...
-- -----------------------------------------------------------------------------
-- 53. [4차 체인 JOIN] C003 <-> I-0020 <-> I0030 <-> I0630
...
-- -----------------------------------------------------------------------------
-- 54. [4차 체인 JOIN] C003 <-> I-0020 <-> I0630 <-> I0030
...
-- -----------------------------------------------------------------------------
-- 55. [4차 체인 JOIN] C003 <-> I0030 <-> I-0020 <-> I0630
...
-- -----------------------------------------------------------------------------
-- 56. [4차 체인 JOIN] C003 <-> I0030 <-> I0630 <-> I-0020
...
-- -----------------------------------------------------------------------------
-- 57. [4차 체인 JOIN] C003 <-> I0630 <-> I-0020 <-> I0030
...
-- -----------------------------------------------------------------------------
-- 58. [4차 체인 JOIN] C003 <-> I0630 <-> I0030 <-> I-0020
...
-- -----------------------------------------------------------------------------
-- 67. [4차 체인 JOIN] C003 <-> I0490 <-> I2580 <-> I0940
...
-- -----------------------------------------------------------------------------
-- 68. [4차 체인 JOIN] C003 <-> I0490 <-> I2580 <-> I2600
...
-- -----------------------------------------------------------------------------
-- 69. [4차 체인 JOIN] C003 <-> I-0020 <-> I0490 <-> I0960
...
-- -----------------------------------------------------------------------------
-- 70. [4차 체인 JOIN] C003 <-> I0630 <-> I0490 <-> I0960
...
-- -----------------------------------------------------------------------------
-- 89. [4차 체인 JOIN] C001 <-> I0490 <-> I0940 <-> I0960
...
-- -----------------------------------------------------------------------------
-- 90. [4차 체인 JOIN] C003 <-> I0490 <-> I2580 <-> I0950
...
-- -----------------------------------------------------------------------------
-- 91. [4차 체인 JOIN] C003 <-> I-0020 <-> I0030 <-> I2852
...
-- -----------------------------------------------------------------------------
-- 92. [4차 체인 JOIN] C003 <-> I-0020 <-> I2852 <-> I0030
...
-- -----------------------------------------------------------------------------
-- 93. [4차 체인 JOIN] C003 <-> I0030 <-> I-0020 <-> I2852
...
-- -----------------------------------------------------------------------------
-- 94. [4차 체인 JOIN] C003 <-> I0030 <-> I0630 <-> I2852
...
-- -----------------------------------------------------------------------------
-- 95. [4차 체인 JOIN] C003 <-> I0030 <-> I2852 <-> I-0020
...
-- -----------------------------------------------------------------------------
-- 96. [4차 체인 JOIN] C003 <-> I0030 <-> I2852 <-> I0630
...
-- -----------------------------------------------------------------------------
-- 97. [4차 체인 JOIN] C003 <-> I0030 <-> I2852 <-> I2860
--   조인 관계: C003 --(LCNS_NO)-->I0030 --(LCNS_NO)-->I2852 --(LCNS_NO)-->I2860
--   실제 매칭 레코드: 686건
-- -----------------------------------------------------------------------------
SELECT
    A."LCNS_NO" AS "인허가번호",
...
-- -----------------------------------------------------------------------------
-- 98. [4차 체인 JOIN] C003 <-> I0030 <-> I2860 <-> I2852
--   조인 관계: C003 --(LCNS_NO)-->I0030 --(LCNS_NO)-->I2860 --(LCNS_NO)-->I2852
--   실제 매칭 레코드: 686건
-- -----------------------------------------------------------------------------
SELECT
    A."LCNS_NO" AS "인허가번호",
...
-- -----------------------------------------------------------------------------
-- 99. [4차 체인 JOIN] C003 <-> I0630 <-> I0030 <-> I2852
...
-- -----------------------------------------------------------------------------
-- 100. [4차 체인 JOIN] C003 <-> I0630 <-> I2852 <-> I0030
...
-- -----------------------------------------------------------------------------
-- 101. [4차 체인 JOIN] C003 <-> I2852 <-> I-0020 <-> I0030
...
-- -----------------------------------------------------------------------------
-- 102. [4차 체인 JOIN] C003 <-> I2852 <-> I0030 <-> I-0020
...
-- -----------------------------------------------------------------------------
-- 103. [4차 체인 JOIN] C003 <-> I2852 <-> I0030 <-> I0630
...
-- -----------------------------------------------------------------------------
-- 104. [4차 체인 JOIN] C003 <-> I2852 <-> I0030 <-> I2860
--   조인 관계: C003 --(LCNS_NO)-->I2852 --(LCNS_NO)-->I0030 --(LCNS_NO)-->I2860
--   실제 매칭 레코드: 686건
-- -----------------------------------------------------------------------------
SELECT
    A."LCNS_NO" AS "인허가번호",
...
-- -----------------------------------------------------------------------------
-- 105. [4차 체인 JOIN] C003 <-> I2852 <-> I0630 <-> I0030
...
-- -----------------------------------------------------------------------------
-- 106. [4차 체인 JOIN] C003 <-> I0490 <-> I0960 <-> I2530
...
-- -----------------------------------------------------------------------------
-- 107. [4차 체인 JOIN] C001 <-> I0490 <-> I0940 <-> I2580
...
-- -----------------------------------------------------------------------------
-- 108. [4차 체인 JOIN] C003 <-> I-0020 <-> I0490 <-> I0630
...
-- -----------------------------------------------------------------------------
-- 109. [4차 체인 JOIN] C003 <-> I-0020 <-> I0630 <-> I0490
...
-- -----------------------------------------------------------------------------
-- 110. [4차 체인 JOIN] C003 <-> I0490 <-> I-0020 <-> I0630
...
-- -----------------------------------------------------------------------------
-- 111. [4차 체인 JOIN] C003 <-> I0490 <-> I0630 <-> I-0020
...
-- -----------------------------------------------------------------------------
-- 112. [4차 체인 JOIN] C003 <-> I0630 <-> I-0020 <-> I0490
...
-- -----------------------------------------------------------------------------
-- 113. [4차 체인 JOIN] C003 <-> I0630 <-> I0490 <-> I-0020
...
-- -----------------------------------------------------------------------------
-- 114. [4차 체인 JOIN] C001 <-> I0490 <-> I2580 <-> I0960
...
-- -----------------------------------------------------------------------------
-- 115. [4차 체인 JOIN] C001 <-> I0490 <-> I2600 <-> I0960
...
-- -----------------------------------------------------------------------------
-- 116. [4차 체인 JOIN] C003 <-> I0030 <-> I0490 <-> I2580
...
-- -----------------------------------------------------------------------------
-- 117. [4차 체인 JOIN] C001 <-> I0490 <-> I2580 <-> I0940
...
-- -----------------------------------------------------------------------------
-- 118. [4차 체인 JOIN] C001 <-> I0490 <-> I2600 <-> I2580
...
-- -----------------------------------------------------------------------------
-- 119. [4차 체인 JOIN] C001 <-> I0490 <-> I0940 <-> I2600
...
-- -----------------------------------------------------------------------------
-- 120. [4차 체인 JOIN] C003 <-> I-0020 <-> I0490 <-> I2580
...
-- -----------------------------------------------------------------------------
-- 121. [4차 체인 JOIN] C003 <-> I0630 <-> I0490 <-> I2580
...
-- -----------------------------------------------------------------------------
-- 122. [4차 체인 JOIN] C001 <-> I0490 <-> I2600 <-> I0940
...
-- -----------------------------------------------------------------------------
-- 123. [4차 체인 JOIN] C003 <-> I0490 <-> I2580 <-> I2530
...
-- -----------------------------------------------------------------------------
-- 124. [4차 체인 JOIN] C003 <-> I-0020 <-> I0630 <-> I2852
...
-- -----------------------------------------------------------------------------
-- 125. [4차 체인 JOIN] C003 <-> I-0020 <-> I2852 <-> I0630
...
-- -----------------------------------------------------------------------------
-- 126. [4차 체인 JOIN] C003 <-> I-0020 <-> I2852 <-> I2860
--   조인 관계: C003 --(LCNS_NO)-->I-0020 --(LCNS_NO)-->I2852 --(LCNS_NO)-->I2860
--   실제 매칭 레코드: 98건
-- -----------------------------------------------------------------------------
SELECT
    A."LCNS_NO" AS "인허가번호",
...
-- -----------------------------------------------------------------------------
-- 127. [4차 체인 JOIN] C003 <-> I-0020 <-> I2860 <-> I2852
--   조인 관계: C003 --(LCNS_NO)-->I-0020 --(LCNS_NO)-->I2860 --(LCNS_NO)-->I2852
--   실제 매칭 레코드: 98건
-- -----------------------------------------------------------------------------
SELECT
    A."LCNS_NO" AS "인허가번호",
...
-- -----------------------------------------------------------------------------
-- 128. [4차 체인 JOIN] C003 <-> I0630 <-> I-0020 <-> I2852
...
-- -----------------------------------------------------------------------------
-- 129. [4차 체인 JOIN] C003 <-> I0630 <-> I2852 <-> I-0020
...
-- -----------------------------------------------------------------------------
-- 130. [4차 체인 JOIN] C003 <-> I0630 <-> I2852 <-> I2860
--   조인 관계: C003 --(LCNS_NO)-->I0630 --(LCNS_NO)-->I2852 --(LCNS_NO)-->I2860
--   실제 매칭 레코드: 98건
-- -----------------------------------------------------------------------------
SELECT
    A."LCNS_NO" AS "인허가번호",
...
-- -----------------------------------------------------------------------------
-- 131. [4차 체인 JOIN] C003 <-> I0630 <-> I2860 <-> I2852
--   조인 관계: C003 --(LCNS_NO)-->I0630 --(LCNS_NO)-->I2860 --(LCNS_NO)-->I2852
--   실제 매칭 레코드: 98건
-- -----------------------------------------------------------------------------
SELECT
    A."LCNS_NO" AS "인허가번호",
...
-- -----------------------------------------------------------------------------
-- 132. [4차 체인 JOIN] C003 <-> I2852 <-> I-0020 <-> I0630
...
-- -----------------------------------------------------------------------------
-- 133. [4차 체인 JOIN] C003 <-> I2852 <-> I-0020 <-> I2860
--   조인 관계: C003 --(LCNS_NO)-->I2852 --(LCNS_NO)-->I-0020 --(LCNS_NO)-->I2860
--   실제 매칭 레코드: 98건
-- -----------------------------------------------------------------------------
SELECT
    A."LCNS_NO" AS "인허가번호",
...
-- -----------------------------------------------------------------------------
-- 134. [4차 체인 JOIN] C003 <-> I2852 <-> I0630 <-> I-0020
...
-- -----------------------------------------------------------------------------
-- 135. [4차 체인 JOIN] C003 <-> I2852 <-> I0630 <-> I2860
--   조인 관계: C003 --(LCNS_NO)-->I2852 --(LCNS_NO)-->I0630 --(LCNS_NO)-->I2860
--   실제 매칭 레코드: 98건
-- -----------------------------------------------------------------------------
SELECT
    A."LCNS_NO" AS "인허가번호",
...
-- -----------------------------------------------------------------------------
-- 136. [4차 체인 JOIN] C001 <-> I0490 <-> I2580 <-> I2600
...
-- -----------------------------------------------------------------------------
-- 137. [4차 체인 JOIN] C001 <-> I0490 <-> I0940 <-> I0950
...
-- -----------------------------------------------------------------------------
-- 138. [4차 체인 JOIN] C001 <-> I1260 <-> I0490 <-> I0940
...
-- -----------------------------------------------------------------------------
-- 139. [4차 체인 JOIN] C001 <-> I0490 <-> I2580 <-> I0950
...
-- -----------------------------------------------------------------------------
-- 140. [4차 체인 JOIN] C001 <-> I0490 <-> I2600 <-> I0950
...
-- -----------------------------------------------------------------------------
-- 141. [4차 체인 JOIN] C001 <-> I0490 <-> I0940 <-> I2530
...
-- -----------------------------------------------------------------------------
-- 142. [4차 체인 JOIN] C002 <-> I0080 <-> I2500 <-> I2560
...
-- -----------------------------------------------------------------------------
-- 143. [4차 체인 JOIN] C002 <-> I0080 <-> I2560 <-> I2500
...
-- -----------------------------------------------------------------------------
-- 144. [4차 체인 JOIN] C002 <-> I2500 <-> I0080 <-> I2560
...
-- -----------------------------------------------------------------------------
-- 145. [4차 체인 JOIN] C002 <-> I2500 <-> I2560 <-> I0080
...
-- -----------------------------------------------------------------------------
-- 146. [4차 체인 JOIN] C002 <-> I2560 <-> I0080 <-> I2500
...
-- -----------------------------------------------------------------------------
-- 147. [4차 체인 JOIN] C002 <-> I2560 <-> I2500 <-> I0080
...
-- -----------------------------------------------------------------------------
-- 148. [4차 체인 JOIN] C001 <-> I0490 <-> I2600 <-> I2590
...
-- -----------------------------------------------------------------------------
-- 149. [4차 체인 JOIN] C001 <-> I1260 <-> I0490 <-> I2580
...
-- -----------------------------------------------------------------------------
-- 150. [4차 체인 JOIN] C001 <-> I1260 <-> I0490 <-> I2600
...
-- -----------------------------------------------------------------------------
-- 151. [4차 체인 JOIN] C001 <-> I0490 <-> I2580 <-> I2530
...
-- -----------------------------------------------------------------------------
-- 152. [4차 체인 JOIN] C002 <-> I0060 <-> I0680 <-> I1540
...
-- -----------------------------------------------------------------------------
-- 153. [4차 체인 JOIN] C002 <-> I0060 <-> I1540 <-> I0680
...
-- -----------------------------------------------------------------------------
-- 154. [4차 체인 JOIN] C002 <-> I0680 <-> I0060 <-> I1540
...
-- -----------------------------------------------------------------------------
-- 155. [4차 체인 JOIN] C002 <-> I0680 <-> I1540 <-> I0060
...
-- -----------------------------------------------------------------------------
-- 156. [4차 체인 JOIN] C002 <-> I1540 <-> I0060 <-> I0680
...
-- -----------------------------------------------------------------------------
-- 157. [4차 체인 JOIN] C002 <-> I1540 <-> I0680 <-> I0060
...
-- -----------------------------------------------------------------------------
-- 158. [4차 체인 JOIN] C001 <-> I0490 <-> I2600 <-> I2530
...
-- -----------------------------------------------------------------------------
-- 159. [3차 체인 JOIN] C003 <-> I0310 <-> I2860
...
-- -----------------------------------------------------------------------------
-- 160. [3차 체인 JOIN] C003 <-> I2860 <-> I0310
...
-- -----------------------------------------------------------------------------
-- 161. [3차 체인 JOIN] C003 <-> I0030 <-> I2860
...
-- -----------------------------------------------------------------------------
-- 162. [3차 체인 JOIN] C003 <-> I2860 <-> I0030
...
-- -----------------------------------------------------------------------------
-- 163. [3차 체인 JOIN] C003 <-> I-0020 <-> I0310
...
-- -----------------------------------------------------------------------------
-- 164. [3차 체인 JOIN] C003 <-> I0310 <-> I-0020
...
-- -----------------------------------------------------------------------------
-- 165. [3차 체인 JOIN] C003 <-> I0310 <-> I0630
...
-- -----------------------------------------------------------------------------
-- 166. [3차 체인 JOIN] C003 <-> I0630 <-> I0310
...
-- -----------------------------------------------------------------------------
-- 167. [3차 체인 JOIN] C003 <-> I0030 <-> I0310
...
-- -----------------------------------------------------------------------------
-- 168. [3차 체인 JOIN] C003 <-> I0310 <-> I0030
...
-- -----------------------------------------------------------------------------
-- 169. [3차 체인 JOIN] C003 <-> I-0020 <-> I2860
...
-- -----------------------------------------------------------------------------
-- 170. [3차 체인 JOIN] C003 <-> I0630 <-> I2860
...
-- -----------------------------------------------------------------------------
-- 171. [3차 체인 JOIN] C003 <-> I2860 <-> I-0020
...
-- -----------------------------------------------------------------------------
-- 172. [3차 체인 JOIN] C003 <-> I2860 <-> I0630
...
-- -----------------------------------------------------------------------------
-- 173. [3차 체인 JOIN] C003 <-> I-0020 <-> I0030
...
-- -----------------------------------------------------------------------------
-- 174. [3차 체인 JOIN] C003 <-> I0030 <-> I-0020
...
-- -----------------------------------------------------------------------------
-- 175. [3차 체인 JOIN] C003 <-> I0030 <-> I0630
...
-- -----------------------------------------------------------------------------
-- 176. [3차 체인 JOIN] C003 <-> I0630 <-> I0030
...
-- -----------------------------------------------------------------------------
-- 177. [3차 체인 JOIN] C003 <-> I0490 <-> I2860
...
-- -----------------------------------------------------------------------------
-- 178. [3차 체인 JOIN] C003 <-> I2860 <-> I0490
...
-- -----------------------------------------------------------------------------
-- 179. [3차 체인 JOIN] C002 <-> I0300 <-> I1220
...
-- -----------------------------------------------------------------------------
-- 180. [3차 체인 JOIN] C002 <-> I1220 <-> I0300
...
-- -----------------------------------------------------------------------------
-- 181. [3차 체인 JOIN] C003 <-> I0490 <-> I0960
...
-- -----------------------------------------------------------------------------
-- 182. [3차 체인 JOIN] C003 <-> I0030 <-> I0490
...
-- -----------------------------------------------------------------------------
-- 183. [3차 체인 JOIN] C003 <-> I0490 <-> I0030
...
-- -----------------------------------------------------------------------------
-- 184. [3차 체인 JOIN] C003 <-> I-0020 <-> I0630
...
-- -----------------------------------------------------------------------------
-- 185. [3차 체인 JOIN] C003 <-> I0630 <-> I-0020
...
-- -----------------------------------------------------------------------------
-- 186. [3차 체인 JOIN] C002 <-> I1250 <-> I2500
...
-- -----------------------------------------------------------------------------
-- 187. [3차 체인 JOIN] C002 <-> I1250 <-> I2560
...
-- -----------------------------------------------------------------------------
-- 188. [3차 체인 JOIN] C002 <-> I2500 <-> I1250
...
-- -----------------------------------------------------------------------------
-- 189. [3차 체인 JOIN] C002 <-> I2560 <-> I1250
...
-- -----------------------------------------------------------------------------
-- 190. [3차 체인 JOIN] C003 <-> I0030 <-> I2852
...
-- -----------------------------------------------------------------------------
-- 191. [3차 체인 JOIN] C003 <-> I2852 <-> I0030
...
-- -----------------------------------------------------------------------------
-- 192. [3차 체인 JOIN] C003 <-> I-0020 <-> I0490
...
-- -----------------------------------------------------------------------------
-- 193. [3차 체인 JOIN] C003 <-> I0490 <-> I-0020
...
-- -----------------------------------------------------------------------------
-- 194. [3차 체인 JOIN] C003 <-> I0490 <-> I0630
...
-- -----------------------------------------------------------------------------
-- 195. [3차 체인 JOIN] C003 <-> I0630 <-> I0490
...
-- -----------------------------------------------------------------------------
-- 196. [3차 체인 JOIN] C003 <-> I0490 <-> I2580
...
-- -----------------------------------------------------------------------------
-- 197. [3차 체인 JOIN] C003 <-> I-0020 <-> I2852
...
-- -----------------------------------------------------------------------------
-- 198. [3차 체인 JOIN] C003 <-> I0630 <-> I2852
...
-- -----------------------------------------------------------------------------
-- 199. [3차 체인 JOIN] C003 <-> I2852 <-> I-0020
...
-- -----------------------------------------------------------------------------
-- 200. [3차 체인 JOIN] C003 <-> I2852 <-> I0630
...
-- -----------------------------------------------------------------------------
-- 201. [3차 체인 JOIN] C003 <-> I2852 <-> I2860
--   조인 관계: C003 --(LCNS_NO)-->I2852 --(LCNS_NO)-->I2860
--   실제 매칭 레코드: 98건
-- -----------------------------------------------------------------------------
SELECT
    A."LCNS_NO" AS "인허가번호",
...
-- -----------------------------------------------------------------------------
-- 202. [3차 체인 JOIN] C003 <-> I2860 <-> I2852
--   조인 관계: C003 --(LCNS_NO)-->I2860 --(LCNS_NO)-->I2852
--   실제 매칭 레코드: 98건
-- -----------------------------------------------------------------------------
SELECT
    A."LCNS_NO" AS "인허가번호",
...
-- -----------------------------------------------------------------------------
-- 203. [3차 체인 JOIN] C002 <-> I1220 <-> I2859
...
-- -----------------------------------------------------------------------------
-- 204. [3차 체인 JOIN] C002 <-> I2859 <-> I1220
...
-- -----------------------------------------------------------------------------
-- 205. [3차 체인 JOIN] C002 <-> I0580 <-> I2852
...
-- -----------------------------------------------------------------------------
-- 206. [3차 체인 JOIN] C002 <-> I2852 <-> I0580
...
-- -----------------------------------------------------------------------------
-- 207. [3차 체인 JOIN] C001 <-> I0490 <-> I0940
...
-- -----------------------------------------------------------------------------
-- 208. [3차 체인 JOIN] C002 <-> I0080 <-> I2500
...
-- -----------------------------------------------------------------------------
-- 209. [3차 체인 JOIN] C002 <-> I0080 <-> I2560
...
-- -----------------------------------------------------------------------------
-- 210. [3차 체인 JOIN] C002 <-> I2500 <-> I0080
...
-- -----------------------------------------------------------------------------
-- 211. [3차 체인 JOIN] C002 <-> I2560 <-> I0080
...
-- -----------------------------------------------------------------------------
-- 212. [3차 체인 JOIN] C001 <-> I0490 <-> I2580
...
-- -----------------------------------------------------------------------------
-- 213. [3차 체인 JOIN] C001 <-> I0490 <-> I2600
...
-- -----------------------------------------------------------------------------
-- 214. [3차 체인 JOIN] C002 <-> I0580 <-> I1220
...
-- -----------------------------------------------------------------------------
-- 215. [3차 체인 JOIN] C002 <-> I1220 <-> I0580
...
-- -----------------------------------------------------------------------------
-- 216. [3차 체인 JOIN] C002 <-> I2500 <-> I2560
...
-- -----------------------------------------------------------------------------
-- 217. [3차 체인 JOIN] C002 <-> I2560 <-> I2500
...
-- -----------------------------------------------------------------------------
-- 218. [3차 체인 JOIN] C002 <-> I0680 <-> I1540
...
-- -----------------------------------------------------------------------------
-- 219. [3차 체인 JOIN] C002 <-> I1540 <-> I0680
...
-- -----------------------------------------------------------------------------
-- 220. [3차 체인 JOIN] C001 <-> I0490 <-> I1260
...
-- -----------------------------------------------------------------------------
-- 221. [3차 체인 JOIN] C001 <-> I1260 <-> I0490
...
-- -----------------------------------------------------------------------------
-- 222. [3차 체인 JOIN] C002 <-> I0060 <-> I0680
...
-- -----------------------------------------------------------------------------
-- 223. [3차 체인 JOIN] C002 <-> I0060 <-> I1540
...
-- -----------------------------------------------------------------------------
-- 224. [3차 체인 JOIN] C002 <-> I0680 <-> I0060
...
-- -----------------------------------------------------------------------------
-- 225. [3차 체인 JOIN] C002 <-> I1540 <-> I0060
...
-- -----------------------------------------------------------------------------
-- 226. [3차 체인 JOIN] C001 <-> I0250 <-> I1260
...
-- -----------------------------------------------------------------------------
-- 227. [3차 체인 JOIN] C001 <-> I1260 <-> I0250
