...
## SCN_003 — `PRDLST_DCNM` 기반 (MEDIUM, 37점)
...
## SCN_006 — `DSPS_BGNDT` 기반 (MEDIUM, 32점)
...
## SCN_007 — `TESTITM_CD` 기반 (MEDIUM, 21점)
...
## SCN_005 — `PRDLST_CD` 기반 (MEDIUM, 20점)
